...
$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{impliesconsistentwith}}({\mathit{evt\_init}}, {\mathit{evt}}) & = & {\mathrm{has}}_{\mathit{init}}({\mathit{evt}}_i) \land ({\mathit{evt}}_i \neq {\mathit{evt}}) \land {\mathrm{overlap}}_{\mathit{reg}}({\mathit{evt}}_i, {\mathit{evt}}) \Rightarrow {\mathit{evt}}_i \prec_{{\mathit{hb}}} {\mathit{evt}} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{impliestothappensbefore}}({\mathit{evt{\kern-0.1em\scriptstyle 1}}}, {\mathit{evt{\kern-0.1em\scriptstyle 2}}}) & = & {\mathit{evt{\kern-0.1em\scriptstyle 1}}} \prec_{{\mathit{tot}}} {\mathit{evt{\kern-0.1em\scriptstyle 2}}} \Rightarrow {\mathit{evt{\kern-0.1em\scriptstyle 1}}} \prec_{{\mathit{hb}}} {\mathit{evt{\kern-0.1em\scriptstyle 2}}} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\forall}\, {\mathit{evt}}_{\mathsf{i}}, {\mathit{evt}} \in {\mathit{tr}}, {\mathit{ord}}_{\mathit{reg}}({\mathit{evt}}_{\mathsf{i}}) = {\mathit{init}} \land {\mathit{evt}}_{\mathsf{i}} \neq {\mathit{evt}} \land {\mathit{overlap}}({\mathit{evt}}_{\mathsf{i}}, {\mathit{evt}}) \Rightarrow {\mathit{evt}}_{\mathsf{i}} \prec_{{\mathit{hb}}} {\mathit{evt}} & = & {\forall}\, x \in {{\mathit{evt\_init}}^{x}}, y \in {\mathit{tr}} {.} {{\mathrm{impliesconsistentwith}}}{(x, y)} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\forall}\, {\mathit{evt}}, {\mathit{evt}'} \in {\mathit{tr}'}, {\mathit{evt}} \prec_{{\mathit{tot}}} {\mathit{evt}'} \Rightarrow {\mathit{evt}} \prec_{{\mathit{hb}}} {\mathit{evt}'} & = & {\forall}\, x \in {\mathit{tr}'}, y \in {\mathit{tr}'} {.} {{\mathrm{impliestothappensbefore}}}{(x, y)} \\
\end{array}
$$
...
{{\mathit{evt\_init}}^{x}} = {\mathrm{initfilter}}({\mathit{tr}})
 \qquad
{\forall}\, {\mathit{evt}}_{\mathsf{i}}, {\mathit{evt}} \in {\mathit{tr}}, {\mathit{ord}}_{\mathit{reg}}({\mathit{evt}}_{\mathsf{i}}) = {\mathit{init}} \land {\mathit{evt}}_{\mathsf{i}} \neq {\mathit{evt}} \land {\mathit{overlap}}({\mathit{evt}}_{\mathsf{i}}, {\mathit{evt}}) \Rightarrow {\mathit{evt}}_{\mathsf{i}} \prec_{{\mathit{hb}}} {\mathit{evt}}
\end{array}
}{
...
\frac{
\begin{array}{@{}c@{}}
{\neg{\mathit{evt}}_{\mathsf{r}} \prec_{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{w}}}
 \\
...
{{\mathit{evt}}_{\mathsf{w}'}^\ast} = {\mathrm{writefilter}}({\mathit{trace}})
 \\
({\mathit{evt}}_{\mathsf{w}} \prec_{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{w}'} \land {\mathit{evt}}_{\mathsf{w}'} \prec_{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{r}} \Rightarrow k \notin {{\mathrm{range}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}_{\mathsf{w}'}))^\ast
\end{array}
}{
...
{{\mathit{evt}}_{\mathsf{w}'}^\ast} = {\mathrm{writefilter}}({\mathit{trace}})
 \\
({\mathit{evt}}_{\mathsf{r}} \prec_{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{w}} \Rightarrow {\mathit{evt}}_{\mathsf{w}} \prec_{{\mathit{tot}}} {\mathit{evt}}_{\mathsf{w}'} \land {\mathit{evt}}_{\mathsf{w}'} \prec_{{\mathit{tot}}} {\mathit{evt}}_{\mathsf{r}} \land {{\mathrm{sync}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}_{\mathsf{w}}, {\mathit{evt}}_{\mathsf{r}}) \Rightarrow {\neg{{\mathrm{sync}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}_{\mathsf{w}}, {\mathit{evt}}_{\mathsf{r}})})^\ast
 \\
({\mathit{evt}}_{\mathsf{r}} \prec_{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{w}} \Rightarrow {\mathit{evt}}_{\mathsf{w}} \prec_{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{w}'} \land {\mathit{evt}}_{\mathsf{w}'} \prec_{{\mathit{tot}}} {\mathit{evt}}_{\mathsf{r}} \Rightarrow {\neg{{\mathrm{sync}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}_{\mathsf{w}}, {\mathit{evt}}_{\mathsf{r}})})^\ast
 \\
({\mathit{evt}}_{\mathsf{r}} \prec_{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{w}} \Rightarrow {\mathit{evt}}_{\mathsf{w}} \prec_{{\mathit{tot}}} {\mathit{evt}}_{\mathsf{w}'} \land {\mathit{evt}}_{\mathsf{w}'} \prec_{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{r}} \Rightarrow {\neg{{\mathrm{sync}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}_{\mathsf{w}}, {\mathit{evt}}_{\mathsf{r}})})^\ast
\end{array}
}{
...
i~{\mathit{reg}} \vdash {\mathit{tr}'}~\mathsf{suspensionsconsistentwith}~\epsilon
 \\
{\forall}\, {\mathit{evt}}, {\mathit{evt}'} \in {\mathit{tr}'}, {\mathit{evt}} \prec_{{\mathit{tot}}} {\mathit{evt}'} \Rightarrow {\mathit{evt}} \prec_{{\mathit{hb}}} {\mathit{evt}'}
\end{array}
}{
...
{\land}~ {\mathit{timestamp}} \prec_{{\mathit{hb}}} {\mathit{timestamp}'} \\
{\land}~ ({\mathit{act}} \neq \mathsf{spawn})^\ast \\
\end{array} \\
\end{array}
$$
...
{[\textsc{\scriptsize E{-}atomic.load{-}num{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{load}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{otherwise, if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
\quad
\begin{array}[t]{@{}l@{}}
\mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|\mathsf{i{\scriptstyle 32}}|} / 8 > {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|{\mathit{inntype}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array}
} \\
...
{[\textsc{\scriptsize E{-}memory.atomic.notify{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{\mathit{count}})~({\mathsf{memory{.}atomic{.}notify}}{x}~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; (\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~0) & \quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{rd}~{\mathit{ord}}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{\mathit{bytes}}))) \\
{\land}~ a = z~f{.}\mathsf{mems}{}[0] \\
{\land}~ {\mathit{ord}} = \mathsf{seqcst} \\
...
$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}memory.atomic.wait{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~{\mathit{expected}})~(\mathsf{i{\scriptstyle 64}}{.}\mathsf{const}~{\mathit{timeout}})~({\mathsf{memory{.}atomic{.}wait}}{{\mathit{inntype}}}~x~{\mathit{ao}}) & \hookrightarrow & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
