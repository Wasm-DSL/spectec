...
& {\mathit{u{\kern-0.1em\scriptstyle 0}}} & ::= & {u}{\mathsf{{\scriptstyle 0}}} \\
...
& {\mathit{s{\kern-0.1em\scriptstyle 64}}} & ::= & {s}{\mathsf{{\scriptstyle 64}}} \\
...
\mbox{(integer type)} & {\mathit{inntype}} & ::= & {\mathit{addrtype}} \\
...
$$
\begin{array}[t]{@{}lrrl@{}l@{}}
\mbox{(limits range)} & {\mathit{limits}} & ::= & {}[ {\mathit{u{\kern-0.1em\scriptstyle 32}}} .. {{\mathit{u{\kern-0.1em\scriptstyle 32}}}^?} ] \\
& {\mathit{share}} & ::= & \mathsf{shared} ~~|~~ \mathsf{unshared} \\
\mbox{(tag type)} & {\mathit{tagtype}} & ::= & {\mathit{typeuse}} \\
\mbox{(global type)} & {\mathit{globaltype}} & ::= & {\mathsf{mut}^?}~{\mathit{valtype}} \\
\mbox{(memory type)} & {\mathit{memtype}} & ::= & {\mathit{addrtype}}~{\mathit{limits}}~{\mathit{share}}~\mathsf{page} \\
...
$$
\begin{array}[t]{@{}lcl@{}l@{}}
{({\mathit{at}}~{\mathit{lim}}~{\mathit{share}}~\mathsf{page})}{{}[ {{\mathit{tv}}^\ast} := {{\mathit{tu}}^\ast} ]} & = & {\mathit{at}}~{\mathit{lim}}~{\mathit{share}}~\mathsf{page} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{free}}_{\mathit{memtype}}({\mathit{addrtype}}~{\mathit{limits}}~{\mathit{share}}~\mathsf{page}) & = & {\mathrm{free}}_{\mathit{addrtype}}({\mathit{addrtype}}) \\
\end{array}
$$
...
& {{\mathit{atomicpack}}}_{{\mathsf{i}}{N}} & ::= & {i}{N} \\
\end{array}
$$
...
& {{\mathit{rmwop}}}_{{\mathsf{i}}{N}} & ::= & \mathsf{add} ~~|~~ \mathsf{sub} ~~|~~ \mathsf{and} ~~|~~ \mathsf{or} ~~|~~ \mathsf{xor} ~~|~~ \mathsf{xchg} \\
& {{\mathit{atop}}}_{{\mathsf{i}}{N}} & ::= & {{\mathit{sz}}}{\mathsf{\_}}{{\mathsf{u}^?}} & \quad \mbox{if}~ {\mathit{sz}} < N \\
\end{array}
$$

$$
\begin{array}[t]{@{}lrrl@{}l@{}}
& {{\mathit{atloadop}}}_{{\mathsf{i}}{N}} & ::= & {{\mathit{sz}}}{\mathsf{\_}}{\mathsf{u}} & \quad \mbox{if}~ {\mathit{sz}} < N \\
\end{array}
$$

$$
\begin{array}[t]{@{}lrrl@{}l@{}}
& {{\mathit{atstoreop}}}_{{\mathsf{i}}{N}} & ::= & {\mathit{sz}} & \quad \mbox{if}~ {\mathit{sz}} < N \\
\end{array}
$$
...
& & | & {{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{load}}{{{{\mathit{atloadop}}}_{{\mathit{inntype}}}^?}}~{\mathit{memidx}}~{\mathit{memarg}} \\
& & | & {{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{store}}{{{{\mathit{atstoreop}}}_{{\mathit{inntype}}}^?}}~{\mathit{memidx}}~{\mathit{memarg}} \\
& & | & {{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{{{{\mathit{atstoreop}}}_{{\mathit{inntype}}}^?}}~{{\mathit{rmwop}}}_{{\mathit{inntype}}}~{\mathit{memidx}}~{\mathit{memarg}} \\
& & | & {{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}}{{{{\mathit{atstoreop}}}_{{\mathit{inntype}}}^?}}~{\mathit{memidx}}~{\mathit{memarg}} \\
& & | & {\mathsf{memory{.}atomic{.}notify}}{{\mathit{memidx}}}~{\mathit{memarg}} \\
& & | & {\mathsf{memory{.}atomic{.}wait}}{{\mathit{inntype}}}~{\mathit{memidx}}~{\mathit{memarg}} \\
& & | & \mathsf{atomic{.}fence} \\
...
$$
\begin{array}[t]{@{}lrrl@{}l@{}}
& {\mathit{addrlen}} & ::= & 0 ~~|~~ 1 ~~|~~ 2 ~~|~~ \dots \\
& {\mathit{region}} & ::= & \mathsf{reglen}~{\mathit{memidx}} \\
& & | & \mathsf{regdata}~{\mathit{memidx}} \\
& {\mathit{location}} & ::= & {\mathit{region}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}} & \quad \mbox{if}~ {\mathit{region}} = \mathsf{reglen}~{\mathit{memidx}} \Rightarrow {\mathit{u{\kern-0.1em\scriptstyle 32}}} = 0 \\
& {\mathit{timestamp}} & ::= & 0 ~~|~~ 1 ~~|~~ 2 ~~|~~ \dots \\
& {\mathit{ord}} & ::= & \mathsf{unord} ~~|~~ \mathsf{seqcst} ~~|~~ \mathsf{init} \\
& {\mathit{notears}} & ::= & \mathsf{notear} \\
& {\mathit{action}} & ::= & \mathsf{rd}~{\mathit{ord}}~{\mathit{location}}~{\mathit{storeval}}~{{\mathit{notears}}^?} \\
& & | & \mathsf{wr}~{\mathit{ord}}~{\mathit{location}}~{\mathit{storeval}}~{{\mathit{notears}}^?} \\
& & | & \mathsf{rmw}~{\mathit{location}}~{\mathit{storeval}}~{\mathit{storeval}} \\
& & | & \mathsf{wait}~{\mathit{location}}~{\mathit{s{\kern-0.1em\scriptstyle 64}}} \\
& & | & \mathsf{woken}~{\mathit{location}} \\
& & | & \mathsf{timeout}~{\mathit{location}} \\
& & | & \mathsf{notify}~{\mathit{location}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}} \\
& & | & \mathsf{fence} \\
& & | & \mathsf{spawn} \\
& & | & \mathsf{hostact} \\
\end{array}
...
$$
\begin{array}[t]{@{}lrrl@{}l@{}}
& {\mathit{event}} & ::= & \{ \begin{array}[t]{@{}l@{}l@{}}
\mathsf{actions}~{{\mathit{action}}^\ast} ,  \mathsf{timep}~{\mathit{timestamp}} ,  \mathsf{time}~{\mathit{timestamp}} \} \\
\end{array} \\
& {\mathit{trace}} & ::= & {{\mathit{event}}^\ast} \\
...
C \vdash {\mathit{addrtype}}~{\mathit{limits}}~{\mathit{share}}~\mathsf{page} : \mathsf{ok}
...
$\boxed{{\mathit{region}} \vdash {\mathit{trace}}~\mathsf{consistentwith}}$

$\boxed{{\vdash}\, {\mathit{trace}}~\mathsf{consistent}}$

$\boxed{{\mathit{trace}}~{\mathit{region}} \vdash {\mathit{event}}~\mathsf{readseachfrom}~{{\mathit{event}}^\ast}}$

$\boxed{{\mathit{trace}}~{\mathit{region}}~\mathbb{N} \vdash {\mathit{event}}~\mathsf{readsfrom}~{\mathit{event}}}$

$\boxed{{\mathit{region}} \vdash {\mathit{event}}~\mathsf{notear}~{{\mathit{event}}^\ast}}$

$\boxed{{\mathit{trace}}~{\mathit{region}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}} \vdash {\mathit{event}}~\mathsf{valueconsistent}~{\mathit{event}}}$

$\boxed{{\mathit{trace}}~{\mathit{region}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}} \vdash {\mathit{event}}~\mathsf{hbconsistent}~{\mathit{event}}}$

$\boxed{{\mathit{trace}}~{\mathit{region}} \vdash {\mathit{event}}~\mathsf{sclastvisible}~{\mathit{event}}}$

$\boxed{{\mathit{u{\kern-0.1em\scriptstyle 32}}}~{\mathit{region}} \vdash {\mathit{trace}}~\mathsf{suspensionsconsistent}}$

$\boxed{{\mathit{u{\kern-0.1em\scriptstyle 32}}}~{\mathit{region}} \vdash {{\mathit{event}}^\ast}~\mathsf{suspensionsconsistentwith}~{{\mathit{timestamp}}^{a}}}$

$\boxed{{\mathit{event}}~\mathsf{happensbefore}~{\mathit{event}}}$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{allreg}} & = & {}[(\mathsf{reglen}~{\mathit{u{\kern-0.1em\scriptstyle 0}}})] \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathit{reg}} \vdash {\mathit{tr}}~\mathsf{consistentwith} & = & \mathsf{true} & \quad \mbox{if}~ {\mathit{reg}} \vdash {\mathit{tr}}~\mathsf{consistentwith} \\
{\mathit{reg}} \vdash {\mathit{tr}}~\mathsf{consistentwith} & = & \mathsf{false} & \quad \mbox{otherwise} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{suspensionsconsistentfunction}}({\mathit{u{\kern-0.1em\scriptstyle 32}}}, {\mathit{reg}}, {\mathit{trace}}) & = & \mathsf{true} & \quad \mbox{if}~ {\mathit{u{\kern-0.1em\scriptstyle 32}}}~{\mathit{reg}} \vdash {\mathit{trace}}~\mathsf{suspensionsconsistent} \\
{\mathrm{suspensionsconsistentfunction}}({\mathit{u{\kern-0.1em\scriptstyle 32}}}, {\mathit{reg}}, {\mathit{trace}}) & = & \mathsf{false} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{readseachfromfunction}}({\mathit{evt}}, {\mathit{tr}}, {\mathit{reg}}, {{\mathit{evt}'}^\ast}) & = & \mathsf{true} & \quad \mbox{if}~ {\mathit{tr}}~{\mathit{reg}} \vdash {\mathit{evt}}~\mathsf{readseachfrom}~{{\mathit{evt}'}^\ast} \\
{\mathrm{readseachfromfunction}}({\mathit{evt}}, {\mathit{tr}}, {\mathit{reg}}, {{\mathit{evt}'}^\ast}) & = & \mathsf{false} & \quad \mbox{otherwise} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{readsfromfunction}}(i, {\mathit{tr}}, {\mathit{reg}}, {\mathit{evt}}, {{\mathit{evtx}}^{n}}) & = & \mathsf{true} & \quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ i < n \\
{\land}~ {\mathit{tr}}~{\mathit{reg}}~i \vdash {\mathit{evt}}~\mathsf{readsfrom}~{{\mathit{evtx}}^{n}}{}[i] \\
\end{array} \\
{\mathrm{readsfromfunction}}(i, {\mathit{tr}}, {\mathit{reg}}, {\mathit{evt}}, {{\mathit{evtx}}^\ast}) & = & \mathsf{false} & \quad \mbox{otherwise} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\forall}\, x \in {{\mathit{testx}}^\ast} {.} {{\mathrm{p}}}{x} & = & \mathsf{true} & \quad \mbox{if}~ ({\mathrm{p}}({\mathit{testx}}))^\ast \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\forall}\, x \in \epsilon, y \in {{\mathit{testy}}^\ast} {.} {{\mathrm{p}}}{(x, y)} & = & \mathsf{true} \\
{\forall}\, x \in {\mathit{testx}}_1~{{\mathit{testx}}^\ast}, y \in {{\mathit{testy}}^\ast} {.} {{\mathrm{p}}}{(x, y)} & = & {\forall}\, x \in {{\mathit{testx}}^\ast}, y \in {{\mathit{testy}}^\ast} {.} {{\mathrm{p}}}{(x, y)} & \quad \mbox{if}~ ({\mathrm{p}}({\mathit{testx}}_1, {\mathit{testy}}))^\ast \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{impliesconsistentwith}}({\mathit{evt\_init}}, {\mathit{evt}}) & = & {\mathrm{has}}_{\mathit{init}}({\mathit{evt}}_i) \land ({\mathit{evt}}_i \neq {\mathit{evt}}) \land {\mathrm{overlap}}_{\mathit{reg}}({\mathit{evt}}_i, {\mathit{evt}}) \Rightarrow {\mathit{evt}}_i \prec__{{\mathit{hb}}} {\mathit{evt}} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{impliestothappensbefore}}({\mathit{evt{\kern-0.1em\scriptstyle 1}}}, {\mathit{evt{\kern-0.1em\scriptstyle 2}}}) & = & {\mathit{evt{\kern-0.1em\scriptstyle 1}}} \prec__{{\mathit{tot}}} {\mathit{evt{\kern-0.1em\scriptstyle 2}}} \Rightarrow {\mathit{evt{\kern-0.1em\scriptstyle 1}}} \prec__{{\mathit{hb}}} {\mathit{evt{\kern-0.1em\scriptstyle 2}}} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\forall}\, {\mathit{evt}}_{\mathsf{i}}, {\mathit{evt}} \in {\mathit{tr}}, {\mathit{ord}}_{\mathit{reg}}({\mathit{evt}}_{\mathsf{i}}) = {\mathit{init}} \land {\mathit{evt}}_{\mathsf{i}} \neq {\mathit{evt}} \land {\mathit{overlap}}({\mathit{evt}}_{\mathsf{i}}, {\mathit{evt}}) \Rightarrow {\mathit{evt}}_{\mathsf{i}} \prec__{{\mathit{hb}}} {\mathit{evt}} & = & {\forall}\, x \in {{\mathit{evt\_init}}^{x}}, y \in {\mathit{tr}} {.} {{\mathrm{impliesconsistentwith}}}{(x, y)} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\forall}\, {\mathit{evt}}, {\mathit{evt}'} \in {\mathit{tr}'}, {\mathit{evt}} \prec__{{\mathit{tot}}} {\mathit{evt}'} \Rightarrow {\mathit{evt}} \prec__{{\mathit{hb}}} {\mathit{evt}'} & = & {\forall}\, x \in {\mathit{tr}'}, y \in {\mathit{tr}'} {.} {{\mathrm{impliestothappensbefore}}}{(x, y)} \\
\end{array}
$$

$\boxed{{\forall}\, {\mathit{reg}}~{.} \vdash_{{\mathit{reg}}} {\mathit{tr}}~\mathsf{consistentwith}}$

$\boxed{{\forall}\, i~\in~{k^{k<{2^{32}}}}~{.}~i \vdash_{{\mathit{reg}}} {\mathit{tr}}~\mathsf{suspensionsconsistent}}$

$\boxed{{\forall}\, {\mathit{evt}}_{\mathsf{r}} \in {{\mathit{reading}}_{\mathit{reg}}}{{\mathit{tr}}}, {\exists}\, {\mathit{evt}}_{\mathsf{w}}~{.}~{\mathit{tr}} \vdash_{{\mathit{reg}}} {\mathit{evt}}_{\mathsf{r}}~\mathsf{readseachfrom}~{\mathit{evt}}_{\mathsf{w}}}$

$\boxed{{\forall}\, i < {|{{\mathit{evt}}_{\mathsf{w}}^\ast}|} {.} {\mathit{tr}}~i \vdash_{{\mathit{reg}}} {\mathit{evt}}_{\mathsf{r}}~\mathsf{readsfrom}~({{\mathit{evt}}_{\mathsf{w}}^\ast}{}[i])}$

$$
\begin{array}{@{}c@{}}\displaystyle
\frac{
{\forall}\, {\mathit{reg}}~{.} \vdash_{{\mathit{reg}}} {\mathit{tr}}~\mathsf{consistentwith}
}{
{\vdash}\, {\mathit{tr}}~\mathsf{consistent}
} \, {[\textsc{\scriptsize Consistent{-}init}]}
\qquad
\end{array}
$$
...
\frac{
\begin{array}{@{}c@{}}
{\forall}\, i~\in~{k^{k<{2^{32}}}}~{.}~i \vdash_{{\mathit{reg}}} {\mathit{tr}}~\mathsf{suspensionsconsistent}
 \\
{\forall}\, {\mathit{evt}}_{\mathsf{r}} \in {{\mathit{reading}}_{\mathit{reg}}}{{\mathit{tr}}}, {\exists}\, {\mathit{evt}}_{\mathsf{w}}~{.}~{\mathit{tr}} \vdash_{{\mathit{reg}}} {\mathit{evt}}_{\mathsf{r}}~\mathsf{readseachfrom}~{\mathit{evt}}_{\mathsf{w}}
 \\
{{\mathit{evt\_init}}^{x}} = {\mathrm{initfilter}}({\mathit{tr}})
 \qquad
{\forall}\, {\mathit{evt}}_{\mathsf{i}}, {\mathit{evt}} \in {\mathit{tr}}, {\mathit{ord}}_{\mathit{reg}}({\mathit{evt}}_{\mathsf{i}}) = {\mathit{init}} \land {\mathit{evt}}_{\mathsf{i}} \neq {\mathit{evt}} \land {\mathit{overlap}}({\mathit{evt}}_{\mathsf{i}}, {\mathit{evt}}) \Rightarrow {\mathit{evt}}_{\mathsf{i}} \prec__{{\mathit{hb}}} {\mathit{evt}}
\end{array}
}{
{\mathit{reg}} \vdash {\mathit{tr}}~\mathsf{consistentwith}
} \, {[\textsc{\scriptsize Consistentwith{-}init}]}
\qquad
\end{array}
$$
...
\frac{
\begin{array}{@{}c@{}}
{|{{\mathit{evt}}_{\mathsf{w}}^\ast}|} = {|{\mathrm{readingactionfilter}}({\mathit{evt}}_{\mathsf{r}}{.}\mathsf{actions})|}
 \qquad
{\forall}\, i < {|{{\mathit{evt}}_{\mathsf{w}}^\ast}|} {.} {\mathit{tr}}~i \vdash_{{\mathit{reg}}} {\mathit{evt}}_{\mathsf{r}}~\mathsf{readsfrom}~({{\mathit{evt}}_{\mathsf{w}}^\ast}{}[i])
 \\
{\mathit{reg}} \vdash {\mathit{evt}}_{\mathsf{r}}~\mathsf{notear}~{{\mathit{evt}}_{\mathsf{w}}^\ast}
\end{array}
}{
{\mathit{tr}}~{\mathit{reg}} \vdash {\mathit{evt}}_{\mathsf{r}}~\mathsf{readseachfrom}~{{\mathit{evt}}_{\mathsf{w}}^\ast}
} \, {[\textsc{\scriptsize Readseachfrom{-}init}]}
\qquad
\end{array}
$$
...
\frac{
\begin{array}{@{}c@{}}
{\mathit{evt}}_{\mathsf{r}} \neq {\mathit{evt}}_{\mathsf{w}}
 \\
{\mathit{evt}}_{\mathsf{w}} \in {\mathrm{writefilter}}({\mathit{tr}})
 \\
{\mathit{tr}}~{\mathit{reg}}~i~k \vdash {\mathit{evt}}_{\mathsf{r}}~\mathsf{valueconsistent}~{\mathit{evt}}_{\mathsf{w}}
 \\
{\mathit{tr}}~{\mathit{reg}}~k \vdash {\mathit{evt}}_{\mathsf{r}}~\mathsf{hbconsistent}~{\mathit{evt}}_{\mathsf{w}}
 \\
{\mathit{tr}}~{\mathit{reg}} \vdash {\mathit{evt}}_{\mathsf{r}}~\mathsf{sclastvisible}~{\mathit{evt}}_{\mathsf{w}}
\end{array}
}{
{\mathit{tr}}~{\mathit{reg}}~i \vdash {\mathit{evt}}_{\mathsf{r}}~\mathsf{readsfrom}~{\mathit{evt}}_{\mathsf{w}}
} \, {[\textsc{\scriptsize Readsfrom{-}init}]}
\qquad
\end{array}
$$
...
\frac{
\begin{array}{@{}c@{}}
{}[{\mathit{act}}_{\mathsf{r}}] = {\mathrm{regionactionfilter}}({\mathit{reg}}, {\mathit{evt}}_{\mathsf{r}}{.}\mathsf{actions})
 \qquad
{}[{\mathit{act}}_{\mathsf{w}}] = {\mathrm{regionactionfilter}}({\mathit{reg}}, {\mathit{evt}}_{\mathsf{w}}{.}\mathsf{actions})
 \\
k = {\mathrm{offset}}({\mathit{act}}_{\mathsf{r}}) + i
 \qquad
j = k - {\mathrm{offset}}({\mathit{act}}_{\mathsf{w}})
 \\
{{\mathit{read\_actions}}^\ast} = {\mathrm{readingactionfilter}}({\mathit{evt}}_{\mathsf{r}}{.}\mathsf{actions})
 \qquad
{{\mathit{write\_actions}}^\ast} = {\mathrm{writeactionfilter}}({\mathit{evt}}_{\mathsf{w}}{.}\mathsf{actions})
 \\
{{\mathit{read\_actions}}^\ast}{}[i] = {{\mathit{write\_actions}}^\ast}{}[j]
\end{array}
}{
{\mathit{trace}}~{\mathit{reg}}~i~k \vdash {\mathit{evt}}_{\mathsf{r}}~\mathsf{valueconsistent}~{\mathit{evt}}_{\mathsf{w}}
} \, {[\textsc{\scriptsize Valueconsistent{-}init}]}
\qquad
\end{array}
$$
...
\frac{
\begin{array}{@{}c@{}}
{\neg{\mathit{evt}}_{\mathsf{r}} \prec__{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{w}}}
 \\
{{\mathrm{sync}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}_{\mathsf{w}}, {\mathit{evt}}_{\mathsf{r}})
 \\
{{\mathit{evt}}_{\mathsf{w}'}^\ast} = {\mathrm{writefilter}}({\mathit{trace}})
 \\
({\mathit{evt}}_{\mathsf{w}} \prec__{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{w}'} \land {\mathit{evt}}_{\mathsf{w}'} \prec__{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{r}} \Rightarrow k \notin {{\mathrm{range}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}_{\mathsf{w}'}))^\ast
\end{array}
}{
{\mathit{trace}}~{\mathit{reg}}~k \vdash {\mathit{evt}}_{\mathsf{r}}~\mathsf{hbconsistent}~{\mathit{evt}}_{\mathsf{w}}
} \, {[\textsc{\scriptsize Hbconsistent{-}init}]}
\qquad
\end{array}
$$
...
{{\mathit{evt}}_{\mathsf{w}'}^\ast} = {\mathrm{writefilter}}({\mathit{trace}})
 \\
({\mathit{evt}}_{\mathsf{r}} \prec__{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{w}} \Rightarrow {\mathit{evt}}_{\mathsf{w}} \prec__{{\mathit{tot}}} {\mathit{evt}}_{\mathsf{w}'} \land {\mathit{evt}}_{\mathsf{w}'} \prec__{{\mathit{tot}}} {\mathit{evt}}_{\mathsf{r}} \land {{\mathrm{sync}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}_{\mathsf{w}}, {\mathit{evt}}_{\mathsf{r}}) \Rightarrow {\neg{{\mathrm{sync}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}_{\mathsf{w}}, {\mathit{evt}}_{\mathsf{r}})})^\ast
 \\
({\mathit{evt}}_{\mathsf{r}} \prec__{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{w}} \Rightarrow {\mathit{evt}}_{\mathsf{w}} \prec__{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{w}'} \land {\mathit{evt}}_{\mathsf{w}'} \prec__{{\mathit{tot}}} {\mathit{evt}}_{\mathsf{r}} \Rightarrow {\neg{{\mathrm{sync}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}_{\mathsf{w}}, {\mathit{evt}}_{\mathsf{r}})})^\ast
 \\
({\mathit{evt}}_{\mathsf{r}} \prec__{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{w}} \Rightarrow {\mathit{evt}}_{\mathsf{w}} \prec__{{\mathit{tot}}} {\mathit{evt}}_{\mathsf{w}'} \land {\mathit{evt}}_{\mathsf{w}'} \prec__{{\mathit{hb}}} {\mathit{evt}}_{\mathsf{r}} \Rightarrow {\neg{{\mathrm{sync}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}_{\mathsf{w}}, {\mathit{evt}}_{\mathsf{r}})})^\ast
\end{array}
}{
{\mathit{trace}}~{\mathit{reg}} \vdash {\mathit{evt}}_{\mathsf{r}}~\mathsf{sclastvisible}~{\mathit{evt}}_{\mathsf{w}}
} \, {[\textsc{\scriptsize Sclastvisible{-}init}]}
\qquad
\end{array}
$$
...
\begin{array}{@{}c@{}}\displaystyle
\frac{
{{\mathit{evt}}_{\mathsf{w}'}^\ast} = {\mathrm{sameandtearfreefilter}}({\mathit{reg}}, {\mathit{evt}}_{\mathsf{r}}, {{\mathit{evt}}_{\mathsf{w}}^\ast})
 \qquad
{{\mathrm{tearfree}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}_{\mathsf{r}}) \Rightarrow {|{{\mathit{evt}}_{\mathsf{w}'}^\ast}|} \leq 1
}{
{\mathit{reg}} \vdash {\mathit{evt}}_{\mathsf{r}}~\mathsf{notear}~{{\mathit{evt}}_{\mathsf{w}}^\ast}
} \, {[\textsc{\scriptsize Notear{-}init}]}
\qquad
\end{array}
$$
...
\frac{
\begin{array}{@{}c@{}}
{\mathit{tr}'} = {\mathrm{suspfilter}}({\mathit{reg}}, i, {\mathit{tr}})
 \qquad
i~{\mathit{reg}} \vdash {\mathit{tr}'}~\mathsf{suspensionsconsistentwith}~\epsilon
 \\
{\forall}\, {\mathit{evt}}, {\mathit{evt}'} \in {\mathit{tr}'}, {\mathit{evt}} \prec__{{\mathit{tot}}} {\mathit{evt}'} \Rightarrow {\mathit{evt}} \prec__{{\mathit{hb}}} {\mathit{evt}'}
\end{array}
}{
i~{\mathit{reg}} \vdash {\mathit{tr}}~\mathsf{suspensionsconsistent}
} \, {[\textsc{\scriptsize Suspensionsconsistent{-}init}]}
\qquad
\end{array}
$$
...
i~{\mathit{reg}} \vdash \epsilon~\mathsf{suspensionsconsistentwith}~{{\mathit{timestamp}}^\ast}
} \, {[\textsc{\scriptsize Suspensionsconsistentwith{-}init}]}
\qquad
\end{array}
$$
...
\frac{
\begin{array}{@{}c@{}}
{{\mathrm{id}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}) = (\mathsf{wait}~({\mathit{reg}}~i)~{\mathit{s{\kern-0.1em\scriptstyle 64}}})
 \\
i~{\mathit{reg}} \vdash {\mathit{tr}}~\mathsf{suspensionsconsistentwith}~({\mathit{evt}}{.}\mathsf{time}~{{\mathit{time}}^\ast})
\end{array}
}{
i~{\mathit{reg}} \vdash {\mathit{evt}}~{\mathit{tr}}~\mathsf{suspensionsconsistentwith}~{{\mathit{time}}^\ast}
} \, {[\textsc{\scriptsize Suspensionsconsistentwith{-}wait}]}
\qquad
\end{array}
$$
...
\frac{
\begin{array}{@{}c@{}}
{{\mathrm{id}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}) = (\mathsf{timeout}~({\mathit{reg}}~i))
 \\
i~{\mathit{reg}} \vdash {\mathit{tr}}~\mathsf{suspensionsconsistentwith}~({\mathit{evt}}{.}\mathsf{time}~{{\mathit{time{\kern-0.1em\scriptstyle 2}}}^{b}})
\end{array}
}{
i~{\mathit{reg}} \vdash {\mathit{evt}}~{\mathit{tr}}~\mathsf{suspensionsconsistentwith}~({{\mathit{time{\kern-0.1em\scriptstyle 1}}}^{a}}~{\mathit{evt}}{.}\mathsf{timep}~{{\mathit{time{\kern-0.1em\scriptstyle 2}}}^{b}})
} \, {[\textsc{\scriptsize Suspensionsconsistentwith{-}timeout}]}
\qquad
\end{array}
$$
...
\frac{
\begin{array}{@{}c@{}}
({{\mathrm{id}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}) = (\mathsf{woken}~({\mathit{reg}}~i)))^{n}
 \\
{{\mathrm{id}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}_{\mathsf{n}}) = (\mathsf{notify}~{\mathit{location}}~n~k)
 \qquad
n < k \Rightarrow m = 0
 \\
i~{\mathit{reg}} \vdash {\mathit{tr}}~\mathsf{suspensionsconsistentwith}~{{\mathit{time}}^{m}}
\end{array}
}{
i~{\mathit{reg}} \vdash {\mathit{evt}}_{\mathsf{n}}~{{\mathit{evt}}^{n}}~{\mathit{tr}}~\mathsf{suspensionsconsistentwith}~({{\mathit{time}}^{m}}~{({\mathit{evt}}{.}\mathsf{timep})^{n}})
} \, {[\textsc{\scriptsize Suspensionsconsistentwith{-}notify}]}
\qquad
\end{array}
$$
...
C \vdash {\mathit{addrtype}}~{\mathit{limits}}_1~{\mathit{share}}~\mathsf{page} \leq {\mathit{addrtype}}~{\mathit{limits}}_2~{\mathit{share}}~\mathsf{page}
...
\begin{array}{@{}c@{}}\displaystyle
\frac{
C{.}\mathsf{mems}{}[x] = {\mathit{at}}~{\mathit{lim}}~{\mathit{share}}~\mathsf{page}
}{
...
\begin{array}{@{}c@{}}\displaystyle
\frac{
C{.}\mathsf{mems}{}[x_1] = {\mathit{at}}_1~{\mathit{lim}}_1~{\mathit{share}}~\mathsf{page}
 \qquad
C{.}\mathsf{mems}{}[x_2] = {\mathit{at}}_2~{\mathit{lim}}_2~{\mathit{share}}~\mathsf{page}
}{
...
C{.}\mathsf{mems}{}[x] = {\mathit{at}}~{\mathit{lim}}~{\mathit{share}}~\mathsf{page}
 \qquad
{2^{{\mathit{memarg}}{.}\mathsf{align}}} \leq {|{\mathit{inntype}}|} / 8
}{
C \vdash {\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{load}~x~{\mathit{memarg}} : {\mathit{at}} \rightarrow {\mathit{inntype}}
} \, {[\textsc{\scriptsize T{-}instr{-}atomic.load{-}val}]}
\qquad
\end{array}
$$
...
C \vdash {{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{load}}{{M}{\mathsf{\_}}{\mathsf{u}}}~x~{\mathit{memarg}} : {\mathit{at}} \rightarrow {\mathit{inntype}}
} \, {[\textsc{\scriptsize T{-}instr{-}atomic.load{-}pack}]}
\qquad
\end{array}
$$
...
C \vdash {\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{store}~x~{\mathit{memarg}} : {\mathit{at}}~{\mathit{inntype}} \rightarrow \epsilon
} \, {[\textsc{\scriptsize T{-}instr{-}atomic.store{-}val}]}
\qquad
\end{array}
$$
...
C \vdash {{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{store}}{M}~x~{\mathit{memarg}} : {\mathit{at}}~{\mathit{inntype}} \rightarrow \epsilon
} \, {[\textsc{\scriptsize T{-}instr{-}atomic.store{-}pack}]}
\qquad
\end{array}
$$
...
C \vdash {\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}~{\mathit{rmwop}}~x~{\mathit{memarg}} : {\mathit{at}}~{\mathit{inntype}} \rightarrow {\mathit{inntype}}
} \, {[\textsc{\scriptsize T{-}instr{-}atomic.rmw{-}val}]}
\qquad
\end{array}
$$
...
C \vdash {{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{M}~{\mathit{rmwop}}~x~{\mathit{memarg}} : {\mathit{at}}~{\mathit{inntype}} \rightarrow {\mathit{inntype}}
} \, {[\textsc{\scriptsize T{-}instr{-}atomic.rmw{-}pack}]}
\qquad
\end{array}
$$
...
C \vdash {{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}}{{\mathit{rmwop}}}~x~{\mathit{memarg}} : {\mathit{at}}~{\mathit{inntype}}~{\mathit{inntype}} \rightarrow {\mathit{inntype}}
} \, {[\textsc{\scriptsize T{-}instr{-}atomic.rmw.cmpxchg{-}val}]}
\qquad
\end{array}
$$
...
C \vdash {{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}}{M}~x~{\mathit{memarg}} : {\mathit{at}}~{\mathit{inntype}}~{\mathit{inntype}} \rightarrow {\mathit{inntype}}
} \, {[\textsc{\scriptsize T{-}instr{-}atomic.rmw.cmpxchg{-}pack}]}
\qquad
\end{array}
$$
...
C{.}\mathsf{mems}{}[x] = {\mathit{at}}~{\mathit{lim}}~{\mathit{share}}~\mathsf{page}
 \qquad
{2^{{\mathit{memarg}}{.}\mathsf{align}}} = 4
}{
C \vdash {\mathsf{memory{.}atomic{.}notify}}{x}~{\mathit{memarg}} : {\mathit{at}}~\mathsf{i{\scriptstyle 32}} \rightarrow \mathsf{i{\scriptstyle 32}}
} \, {[\textsc{\scriptsize T{-}instr{-}memory.atomic.notify}]}
\qquad
\end{array}
$$
...
C \vdash {\mathsf{memory{.}atomic{.}wait}}{{\mathit{inntype}}}~x~{\mathit{memarg}} : {\mathit{at}}~{\mathit{inntype}}~\mathsf{i{\scriptstyle 64}} \rightarrow \mathsf{i{\scriptstyle 32}}
} \, {[\textsc{\scriptsize T{-}instr{-}memory.atomic.wait}]}
\qquad
\end{array}
$$
...
C \vdash \mathsf{atomic{.}fence} : {\mathit{at}}~\epsilon \rightarrow \epsilon
} \, {[\textsc{\scriptsize T{-}instr{-}atomic.fence}]}
\qquad
\end{array}
$$
...
& & | & \mathsf{trap} \\
& & | & \mathsf{wait'}~{\mathit{location}}~{\mathit{s{\kern-0.1em\scriptstyle 64}}} \\
& & | & \mathsf{perform}~{{\mathit{action}}^\ast} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lrrl@{}l@{}}
\mbox{(thread)} & {\mathit{thread}} & ::= & {\mathit{frame}} ; {{\mathit{instr}}^\ast} ; {\mathit{timestamp}} \\
\mbox{(state)} & {\mathit{state}} & ::= & {\mathit{store}} ; {{\mathit{frame}}^?} \\
\mbox{(configuration)} & {\mathit{config}} & ::= & {\mathit{store}} ; {{\mathit{thread}}^\ast} \\
\mbox{(local configuration)} & {\mathit{lconfig}} & ::= & {\mathit{state}} ; {{\mathit{instr}}^\ast} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lcl@{}l@{}}
(s ; f)~f{.}\mathsf{mems}{}[x] & = & f{.}\mathsf{module}{.}\mathsf{mems}{}[x] \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lcl@{}l@{}}
(s ; f){}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i : j] = {b^\ast}] & = & s{}[{.}\mathsf{mems}{}[f{.}\mathsf{module}{.}\mathsf{mems}{}[x]]{.}\mathsf{bytes}{}[i : j] = {b^\ast}] \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
(s ; f){}[{.}\mathsf{mems}{}[x] = {\mathit{mi}}] & = & s{}[{.}\mathsf{mems}{}[f{.}\mathsf{module}{.}\mathsf{mems}{}[x]] = {\mathit{mi}}] \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
(s ; f){}[{.}\mathsf{datas}{}[x]{.}\mathsf{bytes} = {b^\ast}] & = & s{}[{.}\mathsf{datas}{}[f{.}\mathsf{module}{.}\mathsf{datas}{}[x]]{.}\mathsf{bytes} = {b^\ast}] \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
(s ; f){}[{.}\mathsf{structs}{}[a]{.}\mathsf{fields}{}[i] = {\mathit{fv}}] & = & s{}[{.}\mathsf{structs}{}[a]{.}\mathsf{fields}{}[i] = {\mathit{fv}}] \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
(s ; f){}[{.}\mathsf{arrays}{}[a]{.}\mathsf{fields}{}[i] = {\mathit{fv}}] & = & s{}[{.}\mathsf{arrays}{}[a]{.}\mathsf{fields}{}[i] = {\mathit{fv}}] \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lcl@{}l@{}}
(s ; f){}[{.}\mathsf{structs} \mathrel{{=}{\oplus}} {{\mathit{si}}^\ast}] & = & s{}[{.}\mathsf{structs} \mathrel{{=}{\oplus}} {{\mathit{si}}^\ast}] \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
(s ; f){}[{.}\mathsf{arrays} \mathrel{{=}{\oplus}} {{\mathit{ai}}^\ast}] & = & s{}[{.}\mathsf{arrays} \mathrel{{=}{\oplus}} {{\mathit{ai}}^\ast}] \\
\end{array}
$$
...
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {\mathit{meminst}} = \{ \mathsf{type}~({\mathit{at}}~{}[ i .. {j^?} ]~{\mathit{share}}~\mathsf{page}),\; \mathsf{bytes}~{b^\ast} \} \\
{\land}~ {\mathit{meminst}'} = \{ \mathsf{type}~({\mathit{at}}~{}[ {i'} .. {j^?} ]~{\mathit{share}}~\mathsf{page}),\; \mathsf{bytes}~{b^\ast}~{(\mathtt{0x00})^{n \cdot 64 \, {\mathrm{Ki}}}} \} \\
...
$$
\begin{array}[t]{@{}lrrl@{}l@{}}
& {\mathit{storeval}} & ::= & {\mathit{val}} ~~|~~ \mathsf{bytes}~{{\mathit{byte}}^\ast} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{time}}({\mathit{ev}}) & = & {\mathit{ev}}{.}\mathsf{time} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{timep}}({\mathit{ev}}) & = & {\mathit{ev}}{.}\mathsf{timep} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{locationf}}(\mathsf{rd}~{\mathit{ord}}~{\mathit{location}}~{\mathit{storeval}}) & = & {\mathit{location}} \\
{\mathrm{locationf}}(\mathsf{wr}~{\mathit{ord}}~{\mathit{location}}~{\mathit{storeval}}) & = & {\mathit{location}} \\
{\mathrm{locationf}}(\mathsf{rmw}~{\mathit{location}}~{\mathit{storeval}}~{\mathit{storeval}}) & = & {\mathit{location}} \\
{\mathrm{locationf}}(\mathsf{wait}~{\mathit{location}}~{\mathit{s{\kern-0.1em\scriptstyle 64}}}) & = & {\mathit{location}} \\
{\mathrm{locationf}}(\mathsf{woken}~{\mathit{location}}) & = & {\mathit{location}} \\
{\mathrm{locationf}}(\mathsf{timeout}~{\mathit{location}}) & = & {\mathit{location}} \\
{\mathrm{locationf}}(\mathsf{notify}~{\mathit{location}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}}) & = & {\mathit{location}} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{locinregion}}({\mathit{reg{\kern-0.1em\scriptstyle 1}}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}}, {\mathit{reg}}) & = & \mathsf{true} & \quad \mbox{if}~ {\mathit{reg{\kern-0.1em\scriptstyle 1}}} = {\mathit{reg}} \\
{\mathrm{locinregion}}({\mathit{reg{\kern-0.1em\scriptstyle 1}}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}}, {\mathit{reg}}) & = & \mathsf{false} & \quad \mbox{otherwise} \\
{\mathrm{locinregion}}({\mathit{reg{\kern-0.1em\scriptstyle 1}}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}}, {\mathit{reg}}) & = & \mathsf{true} & \quad \mbox{if}~ {\mathit{reg{\kern-0.1em\scriptstyle 1}}} = {\mathit{reg}} \\
{\mathrm{locinregion}}({\mathit{reg{\kern-0.1em\scriptstyle 1}}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}}, {\mathit{reg}}) & = & \mathsf{false} & \quad \mbox{otherwise} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{ordf}}(\mathsf{rd}~{\mathit{ord}}~{\mathit{location}}~{\mathit{storeval}}) & = & {\mathit{ord}} \\
{\mathrm{ordf}}(\mathsf{wr}~{\mathit{ord}}~{\mathit{location}}~{\mathit{storeval}}) & = & {\mathit{ord}} \\
{\mathrm{ordf}}(\mathsf{rmw}~{\mathit{location}}~{\mathit{storeval}}~{\mathit{storeval{\kern-0.1em\scriptstyle 1}}}) & = & \mathsf{seqcst} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{overlap}}({\mathit{action{\kern-0.1em\scriptstyle 1}}}, {\mathit{action{\kern-0.1em\scriptstyle 2}}}) & = & \mathsf{true} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{same}}({\mathit{act{\kern-0.1em\scriptstyle 1}}}, {\mathit{act{\kern-0.1em\scriptstyle 2}}}) & = & \mathsf{true} & \quad \mbox{if}~ {\mathit{act{\kern-0.1em\scriptstyle 1}}} = {\mathit{act{\kern-0.1em\scriptstyle 2}}} \\
{\mathrm{same}}({\mathit{act{\kern-0.1em\scriptstyle 1}}}, {\mathit{act{\kern-0.1em\scriptstyle 2}}}) & = & \mathsf{false} & \quad \mbox{otherwise} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{reading}}({\mathit{act{\kern-0.1em\scriptstyle 1}}}) & = & \mathsf{true} & \quad \mbox{if}~ {\mathrm{read}}({\mathit{act{\kern-0.1em\scriptstyle 1}}}) \neq \epsilon \\
{\mathrm{reading}}({\mathit{act{\kern-0.1em\scriptstyle 1}}}) & = & \mathsf{false} & \quad \mbox{if}~ {\mathrm{read}}({\mathit{act{\kern-0.1em\scriptstyle 1}}}) = \epsilon \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{has}}_{\mathit{read}}({\mathit{evt}}) & = & \mathsf{true} & \quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {\mathit{act}} \in {\mathit{evt}}{.}\mathsf{actions} \\
{\land}~ {\mathrm{read}}({\mathit{act}}) \neq \epsilon \\
\end{array} \\
{\mathrm{has}}_{\mathit{read}}({\mathit{evt}}) & = & \mathsf{false} & \quad \mbox{otherwise} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{has}}_{\mathit{write}}({\mathit{evt}}) & = & \mathsf{true} & \quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {\mathit{act}} \in {\mathit{evt}}{.}\mathsf{actions} \\
{\land}~ {\mathrm{write}}({\mathit{act}}) \neq \epsilon \\
\end{array} \\
{\mathrm{has}}_{\mathit{write}}({\mathit{evt}}) & = & \mathsf{false} & \quad \mbox{otherwise} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{has}}_{\mathit{init}}({\mathit{evt}}) & = & \mathsf{true} & \quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {\mathit{act}} \in {\mathit{evt}}{.}\mathsf{actions} \\
{\land}~ {\mathrm{ordf}}({\mathit{act}}) = \mathsf{init} \\
\end{array} \\
{\mathrm{has}}_{\mathit{init}}({\mathit{evt}}) & = & \mathsf{false} & \quad \mbox{otherwise} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{get}}_{\mathit{actions}}({\mathit{evt}}) & = & {\mathit{evt}}{.}\mathsf{actions} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{readingactionfilter}}(\epsilon) & = & \epsilon \\
{\mathrm{readingactionfilter}}({\mathit{ac}}~{{\mathit{act}}^\ast}) & = & {\mathit{ac}}~{\mathrm{readingactionfilter}}({{\mathit{act}}^\ast}) & \quad \mbox{if}~ {\mathrm{read}}({\mathit{ac}}) \neq \epsilon \\
{\mathrm{readingactionfilter}}({\mathit{ac}}~{{\mathit{act}}^\ast}) & = & {\mathrm{readingactionfilter}}({{\mathit{act}}^\ast}) & \quad \mbox{otherwise} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{writeactionfilter}}(\epsilon) & = & \epsilon \\
{\mathrm{writeactionfilter}}({\mathit{ac}}~{{\mathit{act}}^\ast}) & = & {\mathit{ac}}~{\mathrm{writeactionfilter}}({{\mathit{act}}^\ast}) & \quad \mbox{if}~ {\mathrm{write}}({\mathit{ac}}) \neq \epsilon \\
{\mathrm{writeactionfilter}}({\mathit{ac}}~{{\mathit{act}}^\ast}) & = & {\mathrm{writeactionfilter}}({{\mathit{act}}^\ast}) & \quad \mbox{otherwise} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{reading}}_{{\mathit{event}}_{\mathit{filter}}}({\mathit{evt}}) & = & & \\
 \multicolumn{4}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}}
\{ \begin{array}[t]{@{}l@{}}
\mathsf{actions}~{\mathrm{readingactionfilter}}({\mathit{evt}}{.}\mathsf{actions}),\; \\
  \mathsf{timep}~{\mathit{evt}}{.}\mathsf{timep},\; \\
  \mathsf{time}~{\mathit{evt}}{.}\mathsf{time} \}\end{array} \\
\end{array}
} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{readingfilter}}(\epsilon) & = & \epsilon \\
{\mathrm{readingfilter}}({\mathit{ev}}~{{\mathit{evt}}^\ast}) & = & {\mathit{ev}}~{\mathrm{readingfilter}}({{\mathit{evt}}^\ast}) & \quad \mbox{if}~ {\mathrm{has}}_{\mathit{read}}({\mathit{ev}}) \\
{\mathrm{readingfilter}}({\mathit{ev}}~{{\mathit{evt}}^\ast}) & = & {\mathrm{readingfilter}}({{\mathit{evt}}^\ast}) & \quad \mbox{otherwise} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{writefilter}}(\epsilon) & = & \epsilon \\
{\mathrm{writefilter}}({\mathit{ev}}~{{\mathit{evt}}^\ast}) & = & {\mathit{ev}}~{\mathrm{writefilter}}({{\mathit{evt}}^\ast}) & \quad \mbox{if}~ {\mathrm{has}}_{\mathit{write}}({\mathit{ev}}) \\
{\mathrm{writefilter}}({\mathit{ev}}~{{\mathit{evt}}^\ast}) & = & {\mathrm{writefilter}}({{\mathit{evt}}^\ast}) & \quad \mbox{otherwise} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{initfilter}}(\epsilon) & = & \epsilon \\
{\mathrm{initfilter}}({\mathit{ev}}~{{\mathit{evt}}^\ast}) & = & {\mathit{ev}}~{\mathrm{initfilter}}({{\mathit{evt}}^\ast}) & \quad \mbox{if}~ {\mathrm{has}}_{\mathit{init}}({\mathit{ev}}) \\
{\mathrm{initfilter}}({\mathit{ev}}~{{\mathit{evt}}^\ast}) & = & {\mathrm{initfilter}}({{\mathit{evt}}^\ast}) & \quad \mbox{otherwise} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{overlap}}_{\mathit{reg}}({\mathit{evt{\kern-0.1em\scriptstyle 1}}}, {\mathit{evt{\kern-0.1em\scriptstyle 2}}}) & = & \mathsf{true} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{writing}}({\mathit{action{\kern-0.1em\scriptstyle 1}}}) & = & {\mathit{action{\kern-0.1em\scriptstyle 1}}} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{susp}}({\mathit{u{\kern-0.1em\scriptstyle 32}}}, \mathsf{wait}~{\mathit{location}}~{\mathit{s{\kern-0.1em\scriptstyle 64}}}) & = & {}[(\mathsf{wait}~{\mathit{location}}~{\mathit{s{\kern-0.1em\scriptstyle 64}}})] \\
{\mathrm{susp}}({\mathit{u{\kern-0.1em\scriptstyle 32}}}, \mathsf{woken}~{\mathit{location}}) & = & {}[(\mathsf{woken}~{\mathit{location}})] \\
{\mathrm{susp}}({\mathit{u{\kern-0.1em\scriptstyle 32}}}, \mathsf{timeout}~{\mathit{location}}) & = & {}[(\mathsf{timeout}~{\mathit{location}})] \\
{\mathrm{susp}}({\mathit{u{\kern-0.1em\scriptstyle 32}}}, \mathsf{notify}~{\mathit{location}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}}) & = & {}[(\mathsf{notify}~{\mathit{location}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}})] \\
{\mathrm{susp}}({\mathit{u{\kern-0.1em\scriptstyle 32}}}, {\mathit{act{\kern-0.1em\scriptstyle 1}}}) & = & \epsilon & \quad \mbox{otherwise} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{read}}(\mathsf{rd}~{\mathit{ord}}~{\mathit{location}}~(\mathsf{bytes}~{\mathit{bs}})) & = & {\mathit{bs}} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{write}}(\mathsf{wr}~{\mathit{ord}}~{\mathit{location}}~(\mathsf{bytes}~{\mathit{bs}})) & = & {\mathit{bs}} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{loc}}_{\mathit{offset}}({\mathit{reg}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}}) & = & {\mathit{u{\kern-0.1em\scriptstyle 32}}} \\
{\mathrm{loc}}_{\mathit{offset}}({\mathit{reg}}~{\mathit{u{\kern-0.1em\scriptstyle 32}}}) & = & {\mathit{u{\kern-0.1em\scriptstyle 32}}} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{offset}}({\mathit{act}}) & = & {\mathrm{loc}}_{\mathit{offset}}({\mathrm{locationf}}({\mathit{act}})) \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{sync}}({\mathit{act{\kern-0.1em\scriptstyle 1}}}, {\mathit{act{\kern-0.1em\scriptstyle 2}}}) & = & \mathsf{true} & \quad \mbox{if}~ {\mathrm{same}}({\mathit{act{\kern-0.1em\scriptstyle 1}}}, {\mathit{act{\kern-0.1em\scriptstyle 2}}}) \land {\mathrm{ordf}}({\mathit{act{\kern-0.1em\scriptstyle 1}}}) = \mathsf{seqcst} \land {\mathrm{ordf}}({\mathit{act{\kern-0.1em\scriptstyle 2}}}) = \mathsf{seqcst} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{unfoldu{\kern-0.1em\scriptstyle 32}}}({\mathit{uint{\kern-0.1em\scriptstyle 32}}}_1, 0) & = & \epsilon \\
{\mathrm{unfoldu{\kern-0.1em\scriptstyle 32}}}({\mathit{uint{\kern-0.1em\scriptstyle 32}}}_1, {\mathit{uint{\kern-0.1em\scriptstyle 32}}}_2) & = & {\mathrm{unfoldu{\kern-0.1em\scriptstyle 32}}}({\mathit{uint{\kern-0.1em\scriptstyle 32}}}_1, {\mathit{uint{\kern-0.1em\scriptstyle 32}}}_2 - 1)~{\mathit{uint{\kern-0.1em\scriptstyle 32}}}_1 + {\mathit{uint{\kern-0.1em\scriptstyle 32}}}_2 \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{max}}({\mathit{n{\kern-0.1em\scriptstyle 1}}}, {\mathit{n{\kern-0.1em\scriptstyle 2}}}) & = & {\mathit{n{\kern-0.1em\scriptstyle 1}}} & \quad \mbox{if}~ {\mathit{n{\kern-0.1em\scriptstyle 1}}} \geq {\mathit{n{\kern-0.1em\scriptstyle 2}}} \\
{\mathrm{max}}({\mathit{n{\kern-0.1em\scriptstyle 1}}}, {\mathit{n{\kern-0.1em\scriptstyle 2}}}) & = & {\mathit{n{\kern-0.1em\scriptstyle 2}}} & \quad \mbox{otherwise} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{range}}({\mathit{act}}) & = & {\mathrm{unfoldu{\kern-0.1em\scriptstyle 32}}}({\mathrm{loc}}_{\mathit{offset}}({\mathrm{locationf}}({\mathit{act}})), {\mathrm{max}}({|{\mathrm{read}}({\mathit{act}})|}, {|{\mathrm{write}}({\mathit{act}})|})) \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{tearfree}}({\mathit{action{\kern-0.1em\scriptstyle 1}}}) & = & \mathsf{true} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{id}}({\mathit{action{\kern-0.1em\scriptstyle 1}}}) & = & {\mathit{action{\kern-0.1em\scriptstyle 1}}} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{funclower}}({\mathit{event{\kern-0.1em\scriptstyle 1}}}) & = & {\mathit{event{\kern-0.1em\scriptstyle 1}}}{.}\mathsf{actions}{}[x] \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{regionactionfilter}}({\mathit{reg}}, \epsilon) & = & \epsilon \\
{\mathrm{regionactionfilter}}({\mathit{reg}}, {\mathit{act}'}~{{\mathit{act}}^\ast}) & = & {}[{\mathit{act}'}] & \quad \mbox{if}~ {\mathrm{regionactionfilter}}({\mathit{reg}}, {{\mathit{act}}^\ast}) = \epsilon \land {\mathrm{locinregion}}({\mathrm{locationf}}({\mathit{act}'}), {\mathit{reg}}) \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{access}}_r({\mathit{reg}}, {\mathit{evt}}) & = & {\mathrm{regionactionfilter}}({\mathit{reg}}, {\mathit{evt}}{.}\mathsf{actions}){}[1] & \quad \mbox{if}~ {|{\mathrm{regionactionfilter}}({\mathit{reg}}, {\mathit{evt}}{.}\mathsf{actions})|} = 1 \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{{\mathrm{p}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}_1, {\mathit{evt}}_2) & = & {\mathrm{p}}({\mathrm{access}}_r({\mathit{reg}}, {\mathit{evt}}_1), {\mathrm{access}}_r({\mathit{reg}}, {\mathit{evt}}_2)) \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{{\mathrm{p}}}{\mathsf{\_}}{{\mathit{reg}}}~({\mathit{evt}}) & = & {\mathrm{p}}({\mathrm{access}}_r({\mathit{reg}}, {\mathit{evt}})) \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{sameandtearfreefilter}}({\mathit{reg}}, {\mathit{evt{\kern-0.1em\scriptstyle 1}}}, \epsilon) & = & \epsilon \\
{\mathrm{sameandtearfreefilter}}({\mathit{reg}}, {\mathit{evt{\kern-0.1em\scriptstyle 1}}}, {\mathit{evt}'}~{{\mathit{evt}}^\ast}) & = & {\mathit{evt}'}~{\mathrm{sameandtearfreefilter}}({\mathit{reg}}, {\mathit{evt{\kern-0.1em\scriptstyle 1}}}, {{\mathit{evt}}^\ast}) & \quad \mbox{if}~ {\mathrm{same}}({\mathrm{access}}_r({\mathit{reg}}, {\mathit{evt{\kern-0.1em\scriptstyle 1}}}), {\mathrm{access}}_r({\mathit{reg}}, {\mathit{evt}'})) \land {\mathrm{tearfree}}({\mathrm{access}}_r({\mathit{reg}}, {\mathit{evt}'})) \\
\end{array}
$$

$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{suspfilter}}({\mathit{reg}}, {\mathit{u{\kern-0.1em\scriptstyle 32}}}, \epsilon) & = & \epsilon \\
{\mathrm{suspfilter}}({\mathit{reg}}, {\mathit{u{\kern-0.1em\scriptstyle 32}}}, {\mathit{evt}'}~{{\mathit{evt}}^\ast}) & = & {\mathit{evt}'}~{\mathrm{suspfilter}}({\mathit{reg}}, {\mathit{u{\kern-0.1em\scriptstyle 32}}}, {{\mathit{evt}}^\ast}) & \quad \mbox{if}~ {\mathrm{susp}}({\mathit{u{\kern-0.1em\scriptstyle 32}}}, {\mathrm{access}}_r({\mathit{reg}}, {\mathit{evt}'})) \neq \epsilon \\
\end{array}
$$
...
$\boxed{{\mathit{config}} \hookrightarrow_{{{\mathit{event}}^?}} {\mathit{config}}}$

$\boxed{{\mathit{lconfig}} \hookrightarrow_{{{\mathit{action}}^\ast}} {\mathit{lconfig}}}$

$\boxed{{{\mathit{instr}}^\ast} \hookrightarrow_{{{\mathit{action}}^\ast}} {{\mathit{instr}}^\ast}}$

$\boxed{{\mathit{lconfig}} \hookrightarrow_{{{\mathit{action}}^\ast}} {{\mathit{instr}}^\ast}}$

$\boxed{{\mathit{lconfig}} \hookrightarrow^\ast_{{{\mathit{action}}^\ast}} {\mathit{lconfig}}}$

\vspace{1ex}

$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}lift}]} \quad & s ; {{\mathit{thread}}^\ast}~(f ; {{\mathit{instr}}^\ast} ; {\mathit{timestamp}})~{{\mathit{thread}}_1^\ast} & {\hookrightarrow}_{(\{ \mathsf{actions}~{{\mathit{act}}^\ast},\;\allowbreak \mathsf{timep}~{\mathit{timestamp}},\;\allowbreak \mathsf{time}~{\mathit{timestamp}'} \})} {} & {s'} ; {{\mathit{thread}}^\ast}~({f'} ; {{\mathit{instr}'}^\ast} ; {\mathit{timestamp}'})~{{\mathit{thread}}_1^\ast} & \quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ s ; f ; {{\mathit{instr}}^\ast} \hookrightarrow_{{{\mathit{act}}^\ast}} {s'} ; {f'} ; {{\mathit{instr}'}^\ast} \\
{\land}~ {\mathit{timestamp}} \prec__{{\mathit{hb}}} {\mathit{timestamp}'} \\
{\land}~ ({\mathit{act}} \neq \mathsf{spawn})^\ast \\
\end{array} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}pure}]} \quad & z ; {{\mathit{instr}}^\ast} & {\hookrightarrow}_{({{\mathit{act}}^\ast})} {} & z ; {{\mathit{instr}'}^\ast} & \quad \mbox{if}~ {{\mathit{instr}}^\ast} \hookrightarrow_{{{\mathit{act}}^\ast}} {{\mathit{instr}'}^\ast} \\
{[\textsc{\scriptsize E{-}read}]} \quad & z ; {{\mathit{instr}}^\ast} & {\hookrightarrow}_{({{\mathit{act}}^\ast})} {} & z ; {{\mathit{instr}'}^\ast} & \quad \mbox{if}~ s ; {{\mathit{instr}}^\ast} \hookrightarrow_{{{\mathit{act}}^\ast}} {{\mathit{instr}'}^\ast} \\
\end{array}
$$

$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}refl}]} \quad & z ; {{\mathit{instr}}^\ast} & {\hookrightarrow^\ast}_{({{\mathit{act}}^\ast})} {} & z ; {{\mathit{instr}}^\ast} \\
{[\textsc{\scriptsize E{-}trans}]} \quad & z ; {{\mathit{instr}}^\ast} & {\hookrightarrow^\ast}_{({{\mathit{act{\kern-0.1em\scriptstyle 1}}}^?}~{{\mathit{act{\kern-0.1em\scriptstyle 2}}}^\ast})} {} & {z''} ; {{\mathit{instr}''}^\ast} & \quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ z ; {{\mathit{instr}}^\ast} \hookrightarrow_{{{\mathit{act{\kern-0.1em\scriptstyle 1}}}^?}} {z'} ; {{\mathit{instr}'}^\ast} \\
{\land}~ {z'} ; {{\mathit{instr}'}^\ast} \hookrightarrow^\ast_{{{\mathit{act{\kern-0.1em\scriptstyle 2}}}^\ast}} {z''} ; {{\mathit{instr}''}^\ast} \\
\end{array} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}ctxt{-}instrs}]} \quad & z ; {{\mathit{val}}^\ast}~{{\mathit{instr}}^\ast}~{{\mathit{instr}}_1^\ast} & {\hookrightarrow}_{({{\mathit{act}}^\ast})} {} & {z'} ; {{\mathit{val}}^\ast}~{{\mathit{instr}'}^\ast}~{{\mathit{instr}}_1^\ast} & \quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ z ; {{\mathit{instr}}^\ast} \hookrightarrow_{{{\mathit{act}}^\ast}} {z'} ; {{\mathit{instr}'}^\ast} \\
{\land}~ {{\mathit{val}}^\ast} \neq \epsilon \lor {{\mathit{instr}}_1^\ast} \neq \epsilon \\
\end{array} \\
{[\textsc{\scriptsize E{-}ctxt{-}label}]} \quad & z ; ({{\mathsf{label}}_{n}}{\{ {{\mathit{instr}}_0^\ast} \}}~{{\mathit{instr}}^\ast}) & {\hookrightarrow}_{({{\mathit{act}}^\ast})} {} & {z'} ; ({{\mathsf{label}}_{n}}{\{ {{\mathit{instr}}_0^\ast} \}}~{{\mathit{instr}'}^\ast}) & \quad \mbox{if}~ z ; {{\mathit{instr}}^\ast} \hookrightarrow_{{{\mathit{act}}^\ast}} {z'} ; {{\mathit{instr}'}^\ast} \\
{[\textsc{\scriptsize E{-}ctxt{-}handler}]} \quad & z ; ({{\mathsf{handler}}_{n}}{\{ {{\mathit{catch}}^\ast} \}}~{{\mathit{instr}}^\ast}) & {\hookrightarrow}_{({{\mathit{act}}^\ast})} {} & {z'} ; ({{\mathsf{handler}}_{n}}{\{ {{\mathit{catch}}^\ast} \}}~{{\mathit{instr}'}^\ast}) & \quad \mbox{if}~ z ; {{\mathit{instr}}^\ast} \hookrightarrow_{{{\mathit{act}}^\ast}} {z'} ; {{\mathit{instr}'}^\ast} \\
{[\textsc{\scriptsize E{-}ctxt{-}frame}]} \quad & s ; f ; ({{\mathsf{frame}}_{n}}{\{ {f'} \}}~{{\mathit{instr}}^\ast}) & {\hookrightarrow}_{({{\mathit{act}}^\ast})} {} & {s'} ; f ; ({{\mathsf{frame}}_{n}}{\{ {f''} \}}~{{\mathit{instr}'}^\ast}) & \quad \mbox{if}~ s ; {f'} ; {{\mathit{instr}}^\ast} \hookrightarrow_{{{\mathit{act}}^\ast}} {s'} ; {f''} ; {{\mathit{instr}'}^\ast} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}admin{-}wake}]} \quad & z ; (\mathsf{wait'}~{\mathit{location}}~{\mathit{signed}}_n) & {\hookrightarrow}_{(\mathsf{woken}~{\mathit{location}})} {} & {z'} ; (\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~0) \\
{[\textsc{\scriptsize E{-}admin{-}susp}]} \quad & z ; (\mathsf{wait'}~{\mathit{location}}~{\mathit{signed}}_n) & {\hookrightarrow}_{(\mathsf{woken}~{\mathit{location}})} {} & {z'} ; (\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~2) & \quad \mbox{if}~ {\mathit{signed}}_n \geq 0 \\
{[\textsc{\scriptsize E{-}admin{-}unchanged}]} \quad & z ; (\mathsf{wait'}~{\mathit{location}}~{\mathit{signed}}_n) & {\hookrightarrow}_{(\mathsf{woken}~{\mathit{location}})} {} & z ; (\mathsf{wait'}~{\mathit{location}}~{\mathit{signed}}_n) \\
{[\textsc{\scriptsize E{-}perform}]} \quad & z ; \mathsf{perform}~{{\mathit{act}}^\ast} & {\hookrightarrow}_{({{\mathit{act}}^\ast})} {} & z ; \epsilon \\
\end{array}
$$
...
{[\textsc{\scriptsize E{-}table.copy{-}zero}]} \quad & z ; ({\mathit{at}}_1{.}\mathsf{const}~i_1)~({\mathit{at}}_2{.}\mathsf{const}~i_2)~({\mathit{at}'}{.}\mathsf{const}~n)~(\mathsf{table{.}copy}~x~y) & \hookrightarrow & \epsilon &  \\
& \multicolumn{4}{@{}l@{}}{\quad
...
\begin{array}[t]{@{}l@{}} ({\mathit{at}}_1{.}\mathsf{const}~i_1)~({\mathit{at}}_2{.}\mathsf{const}~i_2)~(\mathsf{table{.}get}~y)~(\mathsf{table{.}set}~x) \\
  ({\mathit{at}}_1{.}\mathsf{const}~i_1 + 1)~({\mathit{at}}_2{.}\mathsf{const}~i_2 + 1)~({\mathit{at}'}{.}\mathsf{const}~n - 1)~(\mathsf{table{.}copy}~x~y) \end{array} & & \\
 \multicolumn{3}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}}
\quad \mbox{otherwise, if}~ i_1 \leq i_2 \\
\end{array}
} \\
\end{array}
} \\
...
\begin{array}[t]{@{}l@{}} ({\mathit{at}}_1{.}\mathsf{const}~i_1 + n - 1)~({\mathit{at}}_2{.}\mathsf{const}~i_2 + n - 1)~(\mathsf{table{.}get}~y)~(\mathsf{table{.}set}~x) \\
  ({\mathit{at}}_1{.}\mathsf{const}~i_1)~({\mathit{at}}_2{.}\mathsf{const}~i_2)~({\mathit{at}'}{.}\mathsf{const}~n - 1)~(\mathsf{table{.}copy}~x~y) \end{array} & & \\
 \multicolumn{3}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}}
\quad \mbox{otherwise} \\
\end{array}
...
$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}load{-}num{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{nt}}{.}\mathsf{load}~x~{\mathit{ao}}) & \hookrightarrow & ({\mathit{nt}}{.}\mathsf{const}~c) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {\mathit{ea}} = i + {\mathit{ao}}{.}\mathsf{offset} \\
{\land}~ {\mathit{ord}} = \mathsf{unord} \lor {\mathit{ea}} \mathbin{\mathrm{mod}} {|{\mathit{nt}}|} / 8 = 0 \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ {{\mathrm{bytes}}}_{{\mathit{nt}}}(c) = z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[{\mathit{ea}} : {|{\mathit{nt}}|} / 8] \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}load{-}num{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{nt}}{.}\mathsf{load}~x~{\mathit{ao}}) & \hookrightarrow & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
{[\textsc{\scriptsize E{-}load{-}num{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{nt}}{.}\mathsf{load}~x~{\mathit{ao}}) & {\hookrightarrow}_{({\mathit{action}})} {} & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {\mathit{action}} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{shared}~\mathsf{page} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}load{-}num{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{nt}}{.}\mathsf{load}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & ({\mathit{nt}}{.}\mathsf{const}~c) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{\mathit{nlen}}))~(\mathsf{rd}~{\mathit{ord}}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{\mathit{bytes}})~{{\mathit{notears}}^?}) \\
{\land}~ a = z~f{.}\mathsf{mems}{}[0] \\
{\land}~ {\mathit{ea}} = i + {\mathit{ao}}{.}\mathsf{offset} \\
{\land}~ {\mathit{ord}} = \mathsf{unord} \lor {\mathit{ea}} \mathbin{\mathrm{mod}} {|{\mathit{nt}}|} / 8 = 0 \\
{\land}~ {{\mathit{notears}}^?} = {\mathrm{tearing}}({\mathit{nt}}, {|{\mathit{nt}}|} / 8, {\mathit{ao}}{.}\mathsf{offset}) \\
{\land}~ {\mathit{storemem}} = z{.}\mathsf{mems}{}[x] \\
{\land}~ {\mathit{nlen}} = {|{\mathit{storemem}}{.}\mathsf{bytes}|} \\
{\land}~ {\mathit{storemem}}{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{shared}~\mathsf{page} \\
{\land}~ {\mathit{bytes}} = {\mathit{storemem}}{.}\mathsf{bytes}{}[{\mathit{ea}} : {|{\mathit{nt}}|} / 8] \\
{\land}~ {{\mathrm{bytes}}}_{{\mathit{nt}}}(c) = {\mathit{bytes}} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}load{-}pack{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({{\mathsf{i}}{N}{.}\mathsf{load}}{{n}{\mathsf{\_}}{{\mathit{sx}}}}~x~{\mathit{ao}}) & \hookrightarrow & ({\mathsf{i}}{N}{.}\mathsf{const}~{{{{\mathrm{extend}}}_{n, {|{\mathsf{i}}{N}|}}^{{\mathit{sx}}}}}{(c)}) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {\mathit{ea}} = i + {\mathit{ao}}{.}\mathsf{offset} \\
{\land}~ {\mathit{ord}} = \mathsf{unord} \lor {\mathit{ea}} \mathbin{\mathrm{mod}} {|{\mathit{nt}}|} / 8 = 0 \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ {{\mathrm{bytes}}}_{{\mathsf{i}}{n}}(c) = z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[{\mathit{ea}} : n / 8] \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}load{-}pack{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({{\mathsf{i}}{N}{.}\mathsf{load}}{{n}{\mathsf{\_}}{{\mathit{sx}}}}~x~{\mathit{ao}}) & \hookrightarrow & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
{[\textsc{\scriptsize E{-}load{-}pack{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({{\mathsf{i}}{N}{.}\mathsf{load}}{{n}{\mathsf{\_}}{{\mathit{sx}}}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({\mathit{action}})} {} & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {\mathit{action}} = \mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}) \\
...
{[\textsc{\scriptsize E{-}load{-}pack{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({{\mathsf{i}}{N}{.}\mathsf{load}}{{n}{\mathsf{\_}}{{\mathit{sx}}}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & ({\mathsf{i}}{N}{.}\mathsf{const}~{{{{\mathrm{extend}}}_{n, {|{\mathsf{i}}{N}|}}^{{\mathit{sx}}}}}{(c)}) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~\mathsf{seqcst}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{\mathit{nlen}}))~(\mathsf{rd}~\mathsf{seqcst}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{\mathit{bytes}})~{{\mathit{notears}}^?})) \\
{\land}~ a = z~f{.}\mathsf{mems}{}[0] \\
{\land}~ {{\mathit{notears}}^?} = {\mathrm{tearing}}({\mathit{nt}}, {|{\mathit{nt}}|} / 8, {\mathit{ao}}{.}\mathsf{offset}) \\
{\land}~ {\mathit{storemem}} = z{.}\mathsf{mems}{}[x] \\
{\land}~ {\mathit{ea}} = i + {\mathit{ao}}{.}\mathsf{offset} \\
{\land}~ {\mathit{nlen}} = {|{\mathit{storemem}}{.}\mathsf{bytes}|} \\
{\land}~ {\mathit{storemem}}{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{shared}~\mathsf{page} \\
{\land}~ {\mathit{bytes}} = {\mathit{storemem}}{.}\mathsf{bytes}{}[{\mathit{ea}} : n / 8] \\
{\land}~ {{\mathrm{bytes}}}_{{\mathsf{i}}{n}}(c) = {\mathit{bytes}} \\
\end{array}
} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}vload{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}~x~{\mathit{ao}}) & \hookrightarrow & (\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ ({\mathit{ord}} = \mathsf{unord}) \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ {{\mathrm{bytes}}}_{\mathsf{v{\scriptstyle 128}}}(c) = z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|\mathsf{v{\scriptstyle 128}}|} / 8] \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|\mathsf{v{\scriptstyle 128}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}vload{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}~x~{\mathit{ao}}) & \hookrightarrow & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
{[\textsc{\scriptsize E{-}vload{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
{\land}~ a = z~f{.}\mathsf{mems}{}[0] \\
{\land}~ {\mathit{ord}} = \mathsf{unord} \\
{\land}~ {\mathit{storemem}} = z{.}\mathsf{mems}{}[x] \\
{\land}~ {\mathit{ea}} = i + {\mathit{ao}}{.}\mathsf{offset} \\
{\land}~ {\mathit{nlen}} = {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{shared}~\mathsf{page} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}vload{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & (\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{rd}~{\mathit{ord}}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{\mathit{bytes}}))) \\
{\land}~ ({\mathit{ord}} = \mathsf{unord}) \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{shared}~\mathsf{page} \\
{\land}~ {{\mathrm{bytes}}}_{\mathsf{v{\scriptstyle 128}}}(c) = z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|\mathsf{v{\scriptstyle 128}}|} / 8] \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|\mathsf{v{\scriptstyle 128}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
...
{[\textsc{\scriptsize E{-}vload{-}pack{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{{M}{\mathsf{x}}{K}{\mathsf{\_}}{{\mathit{sx}}}}~x~{\mathit{ao}}) & \hookrightarrow & (\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ ({\mathit{ord}} = \mathsf{unord}) \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ ({{\mathrm{bytes}}}_{{\mathsf{i}}{M}}(j) = z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} + k \cdot M / 8 : M / 8])^{k<K} \\
{\land}~ c = {{{{\mathrm{lanes}}}_{{{\mathsf{i}}{N}}{\mathsf{x}}{K}}^{{-1}}}}{({{{{{\mathrm{extend}}}_{M, N}^{{\mathit{sx}}}}}{(j)}^{K}})} \land N = M \cdot 2 \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + M \cdot K / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}vload{-}pack{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{{M}{\mathsf{x}}{K}{\mathsf{\_}}{{\mathit{sx}}}}~x~{\mathit{ao}}) & \hookrightarrow & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
{[\textsc{\scriptsize E{-}vload{-}pack{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{{M}{\mathsf{x}}{K}{\mathsf{\_}}{{\mathit{sx}}}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}vload{-}pack{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{{M}{\mathsf{x}}{K}{\mathsf{\_}}{{\mathit{sx}}}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & (\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{rd}~{\mathit{ord}}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{\mathit{bytes}})~{{\mathit{notears}}^?})) \\
{\land}~ ({\mathit{ord}} = \mathsf{unord}) \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{shared}~\mathsf{page} \\
{\land}~ ({{\mathrm{bytes}}}_{{\mathsf{i}}{M}}(j) = z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} + k \cdot M / 8 : M / 8])^{k<K} \\
{\land}~ c = {{{{\mathrm{lanes}}}_{{{\mathsf{i}}{N}}{\mathsf{x}}{K}}^{{-1}}}}{({{{{{\mathrm{extend}}}_{M, N}^{{\mathit{sx}}}}}{(j)}^{K}})} \land N = M \cdot 2 \\
...
{[\textsc{\scriptsize E{-}vload{-}splat{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{{N}{\mathsf{\_}}{\mathsf{splat}}}~x~{\mathit{ao}}) & \hookrightarrow & (\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ ({\mathit{ord}} = \mathsf{unord}) \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ {{\mathrm{bytes}}}_{{\mathsf{i}}{N}}(j) = z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : N / 8] \\
{\land}~ N = {|{\mathsf{i}}{N}|} \\
{\land}~ M = 128 / N \\
{\land}~ c = {{{{\mathrm{lanes}}}_{{{\mathsf{i}}{N}}{\mathsf{x}}{M}}^{{-1}}}}{({j^{M}})} \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + N / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}vload{-}splat{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{{N}{\mathsf{\_}}{\mathsf{splat}}}~x~{\mathit{ao}}) & \hookrightarrow & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
{[\textsc{\scriptsize E{-}vload{-}splat{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{{N}{\mathsf{\_}}{\mathsf{splat}}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}vload{-}splat{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{{N}{\mathsf{\_}}{\mathsf{splat}}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & (\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{rd}~{\mathit{ord}}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{\mathit{bytes}}))) \\
...
{[\textsc{\scriptsize E{-}vload{-}zero{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{{N}{\mathsf{\_}}{\mathsf{zero}}}~x~{\mathit{ao}}) & \hookrightarrow & (\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ ({\mathit{ord}} = \mathsf{unord}) \\
...
{[\textsc{\scriptsize E{-}vload{-}zero{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{{N}{\mathsf{\_}}{\mathsf{zero}}}~x~{\mathit{ao}}) & \hookrightarrow & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
{[\textsc{\scriptsize E{-}vload{-}zero{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{{N}{\mathsf{\_}}{\mathsf{zero}}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}vload{-}zero{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{{N}{\mathsf{\_}}{\mathsf{zero}}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & (\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{rd}~{\mathit{ord}}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{\mathit{bytes}}))) \\
...
{[\textsc{\scriptsize E{-}vload\_lane{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c_1)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{N}{\mathsf{\_}}{\mathsf{lane}}~x~{\mathit{ao}}~j) & \hookrightarrow & (\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ ({\mathit{ord}} = \mathsf{unord}) \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ {{\mathrm{bytes}}}_{{\mathsf{i}}{N}}(k) = z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : N / 8] \\
{\land}~ N = {|{\mathsf{i}}{N}|} \\
...
{[\textsc{\scriptsize E{-}vload\_lane{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c_1)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{N}{\mathsf{\_}}{\mathsf{lane}}~x~{\mathit{ao}}~j) & \hookrightarrow & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
{[\textsc{\scriptsize E{-}vload\_lane{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c_1)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{N}{\mathsf{\_}}{\mathsf{lane}}~x~{\mathit{ao}}~j) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}vload\_lane{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c_1)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{load}}{N}{\mathsf{\_}}{\mathsf{lane}}~x~{\mathit{ao}}~j) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & (\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{rd}~{\mathit{ord}}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{\mathit{bytes}}))) \\
...
$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}store{-}num{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{nt}}{.}\mathsf{const}~c)~({\mathit{nt}}{.}\mathsf{store}~x~{\mathit{ao}}) & \hookrightarrow & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|{\mathit{nt}}|} / 8] = {b^\ast}] ; \epsilon &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ ({\mathit{ord}} = \mathsf{unord}) \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ {b^\ast} = {{\mathrm{bytes}}}_{{\mathit{nt}}}(c) \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|{\mathit{nt}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}store{-}num{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{nt}}{.}\mathsf{const}~c)~({\mathit{nt}}{.}\mathsf{store}~x~{\mathit{ao}}) & \hookrightarrow & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
{[\textsc{\scriptsize E{-}store{-}num{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{nt}}{.}\mathsf{const}~c)~({\mathit{nt}}{.}\mathsf{store}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{\land}~ {\mathit{ea}} = i + {\mathit{ao}}{.}\mathsf{offset} \\
{\land}~ {\mathit{nlen}} = {|{\mathit{storemem}}{.}\mathsf{bytes}|} \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~{\mathit{shared}}~\mathsf{page} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}store{-}num{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{nt}}{.}\mathsf{const}~c)~({\mathit{nt}}{.}\mathsf{store}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|{\mathit{nt}}|} / 8] = {b^\ast}] ; \epsilon &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{wr}~{\mathit{ord}}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{b^\ast})~{{\mathit{notears}}^?})) \\
{\land}~ a = z~f{.}\mathsf{mems}{}[0] \\
{\land}~ {\mathit{ord}} = \mathsf{unord} \\
{\land}~ {{\mathit{notears}}^?} = {\mathrm{tearing}}({\mathit{nt}}, {|{\mathit{nt}}|} / 8, {\mathit{ao}}{.}\mathsf{offset}) \\
{\land}~ {\mathit{storemem}} = z{.}\mathsf{mems}{}[x] \\
...
{[\textsc{\scriptsize E{-}store{-}pack{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{i}}{N}{.}\mathsf{const}~c)~({{\mathsf{i}}{N}{.}\mathsf{store}}{n}~x~{\mathit{ao}}) & \hookrightarrow & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : n / 8] = {b^\ast}] ; \epsilon &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ ({\mathit{ord}} = \mathsf{unord}) \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ {b^\ast} = {{\mathrm{bytes}}}_{{\mathsf{i}}{n}}({{\mathrm{wrap}}}_{{|{\mathsf{i}}{N}|}, n}(c)) \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + n / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}store{-}pack{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{i}}{N}{.}\mathsf{const}~c)~({{\mathsf{i}}{N}{.}\mathsf{store}}{n}~x~{\mathit{ao}}) & \hookrightarrow & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
{[\textsc{\scriptsize E{-}store{-}pack{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{i}}{N}{.}\mathsf{const}~c)~({{\mathsf{i}}{N}{.}\mathsf{store}}{n}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}store{-}pack{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathsf{i}}{N}{.}\mathsf{const}~c)~({{\mathsf{i}}{N}{.}\mathsf{store}}{n}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : n / 8] = {b^\ast}] ; \epsilon &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{wr}~{\mathit{ord}}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{b^\ast})~{{\mathit{notears}}^?})) \\
...
{[\textsc{\scriptsize E{-}vstore{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{store}~x~{\mathit{ao}}) & \hookrightarrow & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|\mathsf{v{\scriptstyle 128}}|} / 8] = {b^\ast}] ; \epsilon &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ ({\mathit{ord}} = \mathsf{unord}) \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ {b^\ast} = {{\mathrm{bytes}}}_{\mathsf{v{\scriptstyle 128}}}(c) \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|\mathsf{v{\scriptstyle 128}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}vstore{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{store}~x~{\mathit{ao}}) & \hookrightarrow & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
{[\textsc{\scriptsize E{-}vstore{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{nt}}{.}\mathsf{const}~c)~({\mathit{nt}}{.}\mathsf{store}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}vstore{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{store}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|\mathsf{v{\scriptstyle 128}}|} / 8] = {b^\ast}] ; \epsilon &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{wr}~{\mathit{ord}}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{b^\ast})~{{\mathit{notears}}^?})) \\
...
{[\textsc{\scriptsize E{-}vstore\_lane{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{store}}{N}{\mathsf{\_}}{\mathsf{lane}}~x~{\mathit{ao}}~j) & \hookrightarrow & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : N / 8] = {b^\ast}] ; \epsilon &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ ({\mathit{ord}} = \mathsf{unord}) \\
...
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + N \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}vstore\_lane{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{store}}{N}{\mathsf{\_}}{\mathsf{lane}}~x~{\mathit{ao}}~j) & \hookrightarrow & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
{[\textsc{\scriptsize E{-}vstore\_lane{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{store}}{N}{\mathsf{\_}}{\mathsf{lane}}~x~{\mathit{ao}}~j) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{otherwise, if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
{\land}~ a = z~f{.}\mathsf{mems}{}[0] \\
{\land}~ {\mathit{ord}} = \mathsf{unord} \\
{\land}~ {{\mathit{notears}}^?} = {\mathrm{tearing}}({\mathit{nt}}, {|{\mathit{nt}}|} / 8, {\mathit{ao}}{.}\mathsf{offset}) \\
{\land}~ {\mathit{storemem}} = z{.}\mathsf{mems}{}[x] \\
...
{[\textsc{\scriptsize E{-}vstore\_lane{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{v{\scriptstyle 128}}{.}\mathsf{const}~c)~({\mathsf{v{\scriptstyle 128}}{.}\mathsf{store}}{N}{\mathsf{\_}}{\mathsf{lane}}~x~{\mathit{ao}}~j) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : N / 8] = {b^\ast}] ; \epsilon &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{wr}~{\mathit{ord}}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{b^\ast}))) \\
{\land}~ a = z~f{.}\mathsf{mems}{}[0] \\
{\land}~ {\mathit{ord}} = \mathsf{unord} \\
{\land}~ {{\mathit{notears}}^?} = {\mathrm{tearing}}({\mathit{nt}}, {|{\mathit{nt}}|} / 8, {\mathit{ao}}{.}\mathsf{offset}) \\
{\land}~ {\mathit{storemem}} = z{.}\mathsf{mems}{}[x] \\
...
$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}memory.size{-}unshared}]} \quad & z ; (\mathsf{memory{.}size}~x) & \hookrightarrow & ({\mathit{at}}{.}\mathsf{const}~n) &  \\
&&& \multicolumn{2}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ n \cdot 64 \, {\mathrm{Ki}} = {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{at}}~{\mathit{lim}}~{\mathit{share}}~\mathsf{page} \\
\end{array}
} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}memory.grow{-}succeed{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~n)~(\mathsf{memory{.}grow}~x) & \hookrightarrow & z{}[{.}\mathsf{mems}{}[x] = {\mathit{mi}}] ; ({\mathit{at}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} / 64 \, {\mathrm{Ki}}) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ {\mathit{mi}} = {\mathrm{growmem}}(z{.}\mathsf{mems}{}[x], n) \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}memory.grow{-}fail{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~n)~(\mathsf{memory{.}grow}~x) & \hookrightarrow & z ; ({\mathit{at}}{.}\mathsf{const}~{{{{\mathrm{signed}}}_{{|{\mathit{at}}|}}^{{-1}}}}{({-1})}) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}memory.size{-}shared}]} \quad & z ; (\mathsf{memory{.}size}~x) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & ({\mathit{at}}{.}\mathsf{const}~n) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}memory.grow{-}succeed{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~n)~(\mathsf{memory{.}grow}~x) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z{}[{.}\mathsf{mems}{}[x] = {\mathit{mi}}] ; ({\mathit{at}}{.}\mathsf{const}~{\mathit{memsz}}) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {\mathit{memsz}} = {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} / 64 \, {\mathrm{Ki}} \\
{\land}~ {{\mathit{action}}^\ast} = ((\mathsf{rmw}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} + n \cdot 64 \, {\mathrm{Ki}}))~(\mathsf{wr}~\mathsf{seqcst}~((\mathsf{reglen}~a)~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})~(\mathsf{bytes}~{(\mathtt{0x00})^{n \cdot 64 \, {\mathrm{Ki}}}}))) \\
{\land}~ (a = z~f{.}\mathsf{mems}{}[0]) \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{shared}~\mathsf{page} \\
{\land}~ {\mathit{mi}} = {\mathrm{growmem}}(z{.}\mathsf{mems}{}[x], n) \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}memory.grow{-}fail{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~n)~(\mathsf{memory{.}grow}~x) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; ({\mathit{at}}{.}\mathsf{const}~{{{{\mathrm{signed}}}_{{|{\mathit{at}}|}}^{{-1}}}}{({-1})}) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}memory.fill{-}oob}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~{\mathit{val}}~({\mathit{at}}{.}\mathsf{const}~n)~(\mathsf{memory{.}fill}~x) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{shared}~\mathsf{page} \\
{\land}~ i + n > {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}memory.fill{-}zero}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~{\mathit{val}}~({\mathit{at}}{.}\mathsf{const}~n)~(\mathsf{memory{.}fill}~x) & \hookrightarrow & \epsilon &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{otherwise, if}~ n = 0 \\
{\land}~ (z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \land {|z{.}\mathsf{mems}{}[0]{.}\mathsf{bytes}|} = {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}) \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}memory.fill{-}succ}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~{\mathit{val}}~({\mathit{at}}{.}\mathsf{const}~n)~(\mathsf{memory{.}fill}~x) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & \begin{array}[t]{@{}l@{}} ({\mathit{at}}{.}\mathsf{const}~i)~{\mathit{val}}~({\mathsf{i{\scriptstyle 32}}{.}\mathsf{store}}{\mathsf{{\scriptstyle 8}}}~x) \\
  ({\mathit{at}}{.}\mathsf{const}~i + 1)~{\mathit{val}}~({\mathit{at}}{.}\mathsf{const}~n - 1)~(\mathsf{memory{.}fill}~x) \end{array} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{otherwise, if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}memory.copy{-}oob}]} \quad & z ; ({\mathit{at}}_1{.}\mathsf{const}~i_1)~({\mathit{at}}_2{.}\mathsf{const}~i_2)~({\mathit{at}'}{.}\mathsf{const}~n)~(\mathsf{memory{.}copy}~x_1~x_2) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{shared}~\mathsf{page} \\
{\land}~ i_1 + n > {|z{.}\mathsf{mems}{}[x_1]{.}\mathsf{bytes}|} \lor i_2 + n > {|z{.}\mathsf{mems}{}[x_2]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}memory.copy{-}zero}]} \quad & z ; ({\mathit{at}}_1{.}\mathsf{const}~i_1)~({\mathit{at}}_2{.}\mathsf{const}~i_2)~({\mathit{at}'}{.}\mathsf{const}~n)~(\mathsf{memory{.}copy}~x_1~x_2) & \hookrightarrow & \epsilon & \quad
\begin{array}[t]{@{}l@{}}
\mbox{otherwise, if}~ (z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \land {|z{.}\mathsf{mems}{}[0]{.}\mathsf{bytes}|} = {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}) \\
{\land}~ n = 0 \\
\end{array} \\
{[\textsc{\scriptsize E{-}memory.copy{-}le}]} \quad & z ; ({\mathit{at}}_1{.}\mathsf{const}~i_1)~({\mathit{at}}_2{.}\mathsf{const}~i_2)~({\mathit{at}'}{.}\mathsf{const}~n)~(\mathsf{memory{.}copy}~x_1~x_2) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & \begin{array}[t]{@{}l@{}} ({\mathit{at}}_1{.}\mathsf{const}~i_1)~({\mathit{at}}_2{.}\mathsf{const}~i_2)~({\mathsf{i{\scriptstyle 32}}{.}\mathsf{load}}{{\mathsf{{\scriptstyle 8}}}{\mathsf{\_}}{\mathsf{u}}}~x_2)~({\mathsf{i{\scriptstyle 32}}{.}\mathsf{store}}{\mathsf{{\scriptstyle 8}}}~x_1) \\
  ({\mathit{at}}_1{.}\mathsf{const}~i_1 + 1)~({\mathit{at}}_2{.}\mathsf{const}~i_2 + 1)~({\mathit{at}'}{.}\mathsf{const}~n - 1)~(\mathsf{memory{.}copy}~x_1~x_2) \end{array} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{otherwise, if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}memory.copy{-}gt}]} \quad & z ; ({\mathit{at}}_1{.}\mathsf{const}~i_1)~({\mathit{at}}_2{.}\mathsf{const}~i_2)~({\mathit{at}'}{.}\mathsf{const}~n)~(\mathsf{memory{.}copy}~x_1~x_2) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & \begin{array}[t]{@{}l@{}} ({\mathit{at}}_1{.}\mathsf{const}~i_1 + n - 1)~({\mathit{at}}_2{.}\mathsf{const}~i_2 + n - 1)~({\mathsf{i{\scriptstyle 32}}{.}\mathsf{load}}{{\mathsf{{\scriptstyle 8}}}{\mathsf{\_}}{\mathsf{u}}}~x_2)~({\mathsf{i{\scriptstyle 32}}{.}\mathsf{store}}{\mathsf{{\scriptstyle 8}}}~x_1) \\
  ({\mathit{at}}_1{.}\mathsf{const}~i_1)~({\mathit{at}}_2{.}\mathsf{const}~i_2)~({\mathit{at}'}{.}\mathsf{const}~n - 1)~(\mathsf{memory{.}copy}~x_1~x_2) \end{array} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{otherwise, if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}memory.init{-}oob}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~j)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~n)~(\mathsf{memory{.}init}~x~y) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{otherwise, if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{shared}~\mathsf{page} \\
{\land}~ i + n > {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \lor j + n > {|z{.}\mathsf{datas}{}[y]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}memory.init{-}zero}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~j)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~n)~(\mathsf{memory{.}init}~x~y) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & \epsilon &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{otherwise, if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}memory.init{-}succ}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~j)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~n)~(\mathsf{memory{.}init}~x~y) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & \begin{array}[t]{@{}l@{}} ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~z{.}\mathsf{datas}{}[y]{.}\mathsf{bytes}{}[j])~({\mathsf{i{\scriptstyle 32}}{.}\mathsf{store}}{\mathsf{{\scriptstyle 8}}}~x) \\
  ({\mathit{at}}{.}\mathsf{const}~i + 1)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~j + 1)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~n - 1)~(\mathsf{memory{.}init}~x~y) \end{array} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{otherwise, if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}atomic.load{-}num{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{load}~x~{\mathit{ao}}) & \hookrightarrow & ({\mathit{inntype}}{.}\mathsf{const}~c) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ a = z~f{.}\mathsf{mems}{}[0] \\
{\land}~ {\mathit{ord}} = \mathsf{seqcst} \\
{\land}~ {{\mathit{notears}}^?} = {\mathrm{tearing}}({\mathit{nt}}, {|{\mathit{nt}}|} / 8, {\mathit{ao}}{.}\mathsf{offset}) \\
{\land}~ {\mathit{storemem}} = z{.}\mathsf{mems}{}[x] \\
{\land}~ {\mathit{ea}} = i + {\mathit{ao}}{.}\mathsf{offset} \\
{\land}~ {\mathit{nlen}} = {|{\mathit{storemem}}{.}\mathsf{bytes}|} \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ {{\mathrm{bytes}}}_{{\mathsf{i}}{{|{\mathit{inntype}}|}}}(c) = z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|{\mathit{inntype}}|} / 8] \\
{\land}~ (i + {\mathit{ao}}{.}\mathsf{offset}) \mathbin{\mathrm{mod}} {|{\mathit{inntype}}|} / 8 = 0 \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|{\mathit{inntype}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}atomic.load{-}num{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{load}~x~{\mathit{ao}}) & \hookrightarrow & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
{[\textsc{\scriptsize E{-}atomic.load{-}num{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{load}~x~{\mathit{ao}}) & {\hookrightarrow}_{({\mathit{action}})} {} & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{otherwise, if}~ {\mathit{action}} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
{\land}~ a = z~f{.}\mathsf{mems}{}[0] \\
{\land}~ {\mathit{ord}} = \mathsf{seqcst} \\
{\land}~ {{\mathit{notears}}^?} = {\mathrm{tearing}}({\mathit{nt}}, {|{\mathit{nt}}|} / 8, {\mathit{ao}}{.}\mathsf{offset}) \\
{\land}~ {\mathit{storemem}} = z{.}\mathsf{mems}{}[x] \\
...
{[\textsc{\scriptsize E{-}atomic.load{-}num{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{load}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & ({\mathit{inntype}}{.}\mathsf{const}~c) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{rd}~{\mathit{ord}}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{\mathit{bytes}})~{{\mathit{notears}}^?})) \\
...
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{shared}~\mathsf{page} \\
{\land}~ {{\mathrm{bytes}}}_{{\mathsf{i}}{{|{\mathit{inntype}}|}}}(c) = z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|{\mathit{inntype}}|} / 8] \\
{\land}~ (i + {\mathit{ao}}{.}\mathsf{offset}) \mathbin{\mathrm{mod}} n / 8 = 0 \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|{\mathit{inntype}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}atomic.load{-}pack{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{load}}{{n}{\mathsf{\_}}{\mathsf{u}}}~x~{\mathit{ao}}) & \hookrightarrow & ({\mathit{inntype}}{.}\mathsf{const}~{{{{\mathrm{extend}}}_{n, {|{\mathit{inntype}}|}}^{\mathsf{u}}}}{(c)}) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ a = z~f{.}\mathsf{mems}{}[0] \\
...
{\land}~ {\mathit{nlen}} = {|{\mathit{storemem}}{.}\mathsf{bytes}|} \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ {{\mathrm{bytes}}}_{{\mathsf{i}}{n}}(c) = z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : n / 8] \\
{\land}~ (i + {\mathit{ao}}{.}\mathsf{offset}) \mathbin{\mathrm{mod}} n / 8 = 0 \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + n / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}atomic.load{-}pack{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{load}}{{n}{\mathsf{\_}}{\mathsf{u}}}~x~{\mathit{ao}}) & \hookrightarrow & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
{[\textsc{\scriptsize E{-}atomic.load{-}pack{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{load}}{{n}{\mathsf{\_}}{\mathsf{u}}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{otherwise, if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}atomic.load{-}pack{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{load}}{{n}{\mathsf{\_}}{\mathsf{u}}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & ({\mathit{inntype}}{.}\mathsf{const}~{{{{\mathrm{extend}}}_{n, {|{\mathit{inntype}}|}}^{\mathsf{u}}}}{(c)}) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{\mathit{nlen}}))~(\mathsf{rd}~{\mathit{ord}}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{\mathit{bytes}})~{{\mathit{notears}}^?})) \\
...
{\land}~ {\mathit{nlen}} = {|{\mathit{storemem}}{.}\mathsf{bytes}|} \\
{\land}~ {\mathit{storemem}}{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{shared}~\mathsf{page} \\
{\land}~ {{\mathrm{bytes}}}_{{\mathsf{i}}{n}}(c) = {\mathit{storemem}}{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : n / 8] \\
{\land}~ (i + {\mathit{ao}}{.}\mathsf{offset}) \mathbin{\mathrm{mod}} n / 8 = 0 \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + n / 8 \leq {|{\mathit{storemem}}{.}\mathsf{bytes}|} \\
\end{array}
} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lrcl@{}l@{}}
{[\textsc{\scriptsize E{-}atomic.store{-}num{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{store}~x~{\mathit{ao}}) & \hookrightarrow & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|{\mathit{inntype}}|} / 8] = {b^\ast}] ; \epsilon &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ a = z~f{.}\mathsf{mems}{}[0] \\
...
{\land}~ {\mathit{nlen}} = {|{\mathit{storemem}}{.}\mathsf{bytes}|} \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ {b^\ast} = {{\mathrm{bytes}}}_{{\mathsf{i}}{{|{\mathit{inntype}}|}}}(c) \\
{\land}~ (i + {\mathit{ao}}{.}\mathsf{offset}) \mathbin{\mathrm{mod}} {|{\mathit{inntype}}|} / 8 = 0 \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|{\mathit{inntype}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}atomic.store{-}num{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{store}~x~{\mathit{ao}}) & \hookrightarrow & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
{[\textsc{\scriptsize E{-}atomic.store{-}num{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{store}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{otherwise, if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}atomic.store{-}num{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{store}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|{\mathit{inntype}}|} / 8] = {b^\ast}] ; \epsilon &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{wr}~{\mathit{ord}}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{b^\ast})~{{\mathit{notears}}^?})) \\
...
{[\textsc{\scriptsize E{-}atomic.store{-}pack{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{store}}{n}~x~{\mathit{ao}}) & \hookrightarrow & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : n / 8] = {b^\ast}] ; \epsilon &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ a = z~f{.}\mathsf{mems}{}[0] \\
...
{\land}~ {\mathit{nlen}} = {|{\mathit{storemem}}{.}\mathsf{bytes}|} \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ {b^\ast} = {{\mathrm{bytes}}}_{{\mathsf{i}}{n}}({{\mathrm{wrap}}}_{{|{\mathit{inntype}}|}, n}(c)) \\
{\land}~ (i + {\mathit{ao}}{.}\mathsf{offset}) \mathbin{\mathrm{mod}} {|{\mathit{inntype}}|} / 8 = 0 \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + n / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}atomic.store{-}pack{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{store}}{n}~x~{\mathit{ao}}) & \hookrightarrow & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise, if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page}
} \\
{[\textsc{\scriptsize E{-}atomic.store{-}pack{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{store}}{n}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}atomic.store{-}pack{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{store}}{n}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : n / 8] = {b^\ast}] ; \epsilon &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{wr}~{\mathit{ord}}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~{b^\ast})~{{\mathit{notears}}^?})) \\
...
{[\textsc{\scriptsize E{-}atomic.rmw{-}num{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}~{\mathit{rmwop}}~x~{\mathit{ao}}) & \hookrightarrow & & \\
& \multicolumn{4}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}l@{}l@{}}
z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|{\mathit{inntype}}|} / 8] = {b^\ast}] ; ({\mathit{inntype}}{.}\mathsf{const}~d) & & \\
 \multicolumn{3}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}}
\quad
\begin{array}[t]{@{}l@{}}
...
{\land}~ {\mathit{nlen}} = {|{\mathit{storemem}}{.}\mathsf{bytes}|} \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ j = {{\mathit{rmwop}}}{{}_{{\mathit{inntype}}}(c, d)} \\
{\land}~ {b^\ast} = {{\mathrm{bytes}}}_{{\mathsf{i}}{{|{\mathit{inntype}}|}}}(j) \\
{\land}~ {{\mathrm{bytes}}}_{{\mathsf{i}}{{|{\mathit{inntype}}|}}}(d) = z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|{\mathit{inntype}}|} / 8] \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|{\mathit{inntype}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array} \\
\end{array}
} \\
...
{[\textsc{\scriptsize E{-}atomic.rmw{-}num{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}~{\mathit{rmwop}}~x~{\mathit{ao}}) & \hookrightarrow & & \\
& \multicolumn{4}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}l@{}l@{}}
z ; \mathsf{trap} & & \\
 \multicolumn{3}{@{}l@{}}{\quad
...
{[\textsc{\scriptsize E{-}atomic.rmw{-}num{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}~{\mathit{rmwop}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|{\mathit{inntype}}|} / 8] = {b^\ast}] ; ({\mathit{inntype}}{.}\mathsf{const}~d) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{rmw}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes})~(\mathsf{bytes}~{b^\ast}))) \\
{\land}~ a = z~f{.}\mathsf{mems}{}[0] \\
{\land}~ {\mathit{ord}} = \mathsf{seqcst} \\
{\land}~ {{\mathit{notears}}^?} = {\mathrm{tearing}}({\mathit{nt}}, {|{\mathit{nt}}|} / 8, {\mathit{ao}}{.}\mathsf{offset}) \\
{\land}~ {\mathit{storemem}} = z{.}\mathsf{mems}{}[x] \\
...
{[\textsc{\scriptsize E{-}atomic.rmw{-}num{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}~{\mathit{rmwop}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}atomic.rmw{-}num{-}pack{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{n}~{\mathit{rmwop}}~x~{\mathit{ao}}) & \hookrightarrow & & \\
& \multicolumn{4}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}l@{}l@{}}
z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : n / 8] = {b^\ast}] ; ({\mathit{inntype}}{.}\mathsf{const}~d) & & \\
 \multicolumn{3}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}}
\quad
\begin{array}[t]{@{}l@{}}
...
{\land}~ {\mathit{nlen}} = {|{\mathit{storemem}}{.}\mathsf{bytes}|} \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ j = {{\mathit{rmwop}}}{{}_{{\mathrm{inv}}_{\mathit{jsize}}(n)}({{\mathrm{wrap}}}_{{|{\mathit{inntype}}|}, n}(c), {{\mathrm{wrap}}}_{{|{\mathit{inntype}}|}, n}(d))} \\
{\land}~ {b^\ast} = {{\mathrm{bytes}}}_{{\mathsf{i}}{n}}({{{{\mathrm{extend}}}_{n, {|{\mathit{inntype}}|}}^{\mathsf{u}}}}{(j)}) \\
{\land}~ {{\mathrm{bytes}}}_{{\mathsf{i}}{n}}(d) = z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : n / 8] \\
\end{array} \\
\end{array}
} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}atomic.rmw{-}num{-}pack{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{n}~{\mathit{rmwop}}~x~{\mathit{ao}}) & \hookrightarrow & & \\
& \multicolumn{4}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}l@{}l@{}}
z ; \mathsf{trap} & & \\
 \multicolumn{3}{@{}l@{}}{\quad
...
{[\textsc{\scriptsize E{-}atomic.rmw{-}num{-}pack{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{n}~{\mathit{rmwop}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : n / 8] = {b^\ast}] ; ({\mathit{inntype}}{.}\mathsf{const}~d) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{rmw}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes})~(\mathsf{bytes}~{b^\ast}))) \\
...
{[\textsc{\scriptsize E{-}atomic.rmw{-}num{-}pack{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{n}~{\mathit{rmwop}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}atomic.rmw.cmpxchg{-}num{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{const}~g)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}~x~{\mathit{ao}}) & \hookrightarrow & & \\
& \multicolumn{4}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}l@{}l@{}}
z ; \mathsf{trap} & & \\
 \multicolumn{3}{@{}l@{}}{\quad
...
{[\textsc{\scriptsize E{-}atomic.rmw.cmpxchg{-}num{-}equals{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{const}~g)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}~x~{\mathit{ao}}) & \hookrightarrow & & \\
& \multicolumn{4}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}l@{}l@{}}
z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|{\mathit{inntype}}|} / 8] = {b^\ast}] ; ({\mathit{inntype}}{.}\mathsf{const}~d) & & \\
 \multicolumn{3}{@{}l@{}}{\quad
...
{\land}~ d = c \\
{\land}~ {{\mathrm{bytes}}}_{{\mathsf{i}}{{|{\mathit{inntype}}|}}}(d) = z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|{\mathit{inntype}}|} / 8] \\
{\land}~ {b^\ast} = {{\mathrm{bytes}}}_{{\mathsf{i}}{{|{\mathit{inntype}}|}}}(g) \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|{\mathit{inntype}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array} \\
\end{array}
} \\
...
{[\textsc{\scriptsize E{-}atomic.rmww.cmpxchg{-}num{-}notequals{-}val{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{const}~g)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}~x~{\mathit{ao}}) & \hookrightarrow & & \\
& \multicolumn{4}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}l@{}l@{}}
z ; ({\mathit{inntype}}{.}\mathsf{const}~d) & & \\
 \multicolumn{3}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}}
\quad
\begin{array}[t]{@{}l@{}}
...
{[\textsc{\scriptsize E{-}atomic.rmw.cmpxchg{-}num{-}equals{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{const}~g)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : {|{\mathit{inntype}}|} / 8] = {b^\ast}] ; ({\mathit{inntype}}{.}\mathsf{const}~d) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{rmw}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes})~(\mathsf{bytes}~{b^\ast}))) \\
...
{[\textsc{\scriptsize E{-}atomic.rmww.cmpxchg{-}num{-}notequals{-}val{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{const}~g)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; ({\mathit{inntype}}{.}\mathsf{const}~d) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{rmw}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes})~(\mathsf{bytes}~{b^\ast}))) \\
...
{[\textsc{\scriptsize E{-}atomic.rmw.cmpxchg{-}num{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{const}~g)~({\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}atomic.rmw.cmpxchg{-}num{-}equals{-}pack{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{const}~g)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}}{n}~x~{\mathit{ao}}) & \hookrightarrow & & \\
& \multicolumn{4}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}l@{}l@{}}
z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : n / 8] = {b^\ast}] ; ({\mathit{inntype}}{.}\mathsf{const}~d) & & \\
 \multicolumn{3}{@{}l@{}}{\quad
...
{\land}~ d = c \\
{\land}~ {{\mathrm{bytes}}}_{{\mathsf{i}}{n}}(d) = z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : n / 8] \\
{\land}~ {b^\ast} = {{\mathrm{bytes}}}_{{\mathsf{i}}{n}}({{\mathrm{wrap}}}_{{|{\mathit{inntype}}|}, n}(g)) \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|{\mathit{inntype}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array} \\
\end{array}
} \\
...
{[\textsc{\scriptsize E{-}atomic.rmw.cmpxchg{-}num{-}notequals{-}pack{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{const}~g)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}}{n}~x~{\mathit{ao}}) & \hookrightarrow & & \\
& \multicolumn{4}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}l@{}l@{}}
z ; ({\mathit{inntype}}{.}\mathsf{const}~d) & & \\
 \multicolumn{3}{@{}l@{}}{\quad
...
{[\textsc{\scriptsize E{-}atomic.rmw.cmpxchg{-}num{-}equals{-}pack{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{const}~g)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}}{n}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z{}[{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}{}[i + {\mathit{ao}}{.}\mathsf{offset} : n / 8] = {b^\ast}] ; ({\mathit{inntype}}{.}\mathsf{const}~d) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{rmw}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes})~(\mathsf{bytes}~{b^\ast}))) \\
...
{[\textsc{\scriptsize E{-}atomic.rmw.cmpxchg{-}num{-}notequals{-}pack{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{const}~g)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}}{n}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; ({\mathit{inntype}}{.}\mathsf{const}~d) &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{rmw}~((\mathsf{regdata}~a)~{\mathit{ea}})~(\mathsf{bytes}~z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes})~(\mathsf{bytes}~{b^\ast}))) \\
...
{[\textsc{\scriptsize E{-}atomic.rmw.cmpxchg{-}num{-}pack{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~c)~({\mathit{inntype}}{.}\mathsf{const}~g)~({{\mathit{inntype}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}}{n}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}memory.atomic.notify{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{\mathit{count}})~({\mathsf{memory{.}atomic{.}notify}}{x}~{\mathit{ao}}) & \hookrightarrow & z ; (\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~0) & \quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ a = z~f{.}\mathsf{mems}{}[0] \\
{\land}~ {\mathit{ea}} = i + {\mathit{ao}}{.}\mathsf{offset} \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|\mathsf{i{\scriptstyle 32}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
{\land}~ {\mathit{ea}} \mathbin{\mathrm{mod}} {|\mathsf{i{\scriptstyle 32}}|} / 8 = 0 \\
\end{array} \\
{[\textsc{\scriptsize E{-}memory.atomic.notify{-}oob{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{\mathit{count}})~({\mathsf{memory{.}atomic{.}notify}}{x}~{\mathit{ao}}) & \hookrightarrow & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{unshared}~\mathsf{page} \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|\mathsf{i{\scriptstyle 32}}|} / 8 > {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \land i + {\mathit{ao}}{.}\mathsf{offset} + {|{\mathit{inntype}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}memory.atomic.notify{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{\mathit{count}})~({\mathsf{memory{.}atomic{.}notify}}{x}~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = (\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|})) \\
...
{[\textsc{\scriptsize E{-}memory.atomic.notify{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{\mathit{count}})~({\mathsf{memory{.}atomic{.}notify}}{x}~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; (\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~j) & \quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {{\mathit{action}}^\ast} = ((\mathsf{rd}~{\mathit{ord}}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~{|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|}))~(\mathsf{notify}~((\mathsf{regdata}~a)~{\mathit{ea}})~j~{\mathit{count}})) \\
{\land}~ a = z~f{.}\mathsf{mems}{}[0] \\
{\land}~ {\mathit{ea}} = i + {\mathit{ao}}{.}\mathsf{offset} \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{shared}~\mathsf{page} \\
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|\mathsf{i{\scriptstyle 32}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
{\land}~ j \leq {\mathit{count}} \\
\end{array} \\
{[\textsc{\scriptsize E{-}memory.atomic.wait{-}unshared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~{\mathit{expected}})~(\mathsf{i{\scriptstyle 64}}{.}\mathsf{const}~{\mathit{timeout}})~({\mathsf{memory{.}atomic{.}wait}}{{\mathit{inntype}}}~x~{\mathit{ao}}) & \hookrightarrow & z ; \mathsf{trap} & \quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ a = z~f{.}\mathsf{mems}{}[0] \\
{\land}~ {\mathit{ord}} = \mathsf{seqcst} \\
{\land}~ {{\mathit{notears}}^?} = {\mathrm{tearing}}({\mathit{nt}}, {|{\mathit{nt}}|} / 8, {\mathit{ao}}{.}\mathsf{offset}) \\
...
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|{\mathit{inntype}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array} \\
{[\textsc{\scriptsize E{-}memory.atomic.wait{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~{\mathit{expected}})~(\mathsf{i{\scriptstyle 64}}{.}\mathsf{const}~{\mathit{timeout}})~({\mathsf{memory{.}atomic{.}wait}}{{\mathit{inntype}}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & & \\
& \multicolumn{4}{@{}l@{}}{\quad
\begin{array}[t]{@{}l@{}l@{}}
z ; \mathsf{wait'}~((\mathsf{regdata}~a)~{\mathit{ea}})~{\mathit{timeout}} & \quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ a = z~f{.}\mathsf{mems}{}[0] \\
{\land}~ {\mathit{ord}} = \mathsf{seqcst} \\
{\land}~ {{\mathit{notears}}^?} = {\mathrm{tearing}}({\mathit{nt}}, {|{\mathit{nt}}|} / 8, {\mathit{ao}}{.}\mathsf{offset}) \\
...
{[\textsc{\scriptsize E{-}memory.atomic.wait{-}fail{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~{\mathit{expected}})~(\mathsf{i{\scriptstyle 64}}{.}\mathsf{const}~{\mathit{timeout}})~({\mathsf{memory{.}atomic{.}wait}}{{\mathit{inntype}}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; (\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~1) & \quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ a = z~f{.}\mathsf{mems}{}[0] \\
{\land}~ {\mathit{ord}} = \mathsf{seqcst} \\
{\land}~ {{\mathit{notears}}^?} = {\mathrm{tearing}}({\mathit{nt}}, {|{\mathit{nt}}|} / 8, {\mathit{ao}}{.}\mathsf{offset}) \\
...
{\land}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|{\mathit{inntype}}|} / 8 \leq {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
\end{array} \\
{[\textsc{\scriptsize E{-}memory.atomic.wait{-}oob{-}shared}]} \quad & z ; ({\mathit{at}}{.}\mathsf{const}~i)~({\mathit{inntype}}{.}\mathsf{const}~{\mathit{expected}})~(\mathsf{i{\scriptstyle 64}}{.}\mathsf{const}~{\mathit{timeout}})~({\mathsf{memory{.}atomic{.}wait}}{{\mathit{inntype}}}~x~{\mathit{ao}}) & {\hookrightarrow}_{({{\mathit{action}}^\ast})} {} & z ; \mathsf{trap} &  \\
& \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ i + {\mathit{ao}}{.}\mathsf{offset} + {|{\mathit{inntype}}|} / 8 > {|z{.}\mathsf{mems}{}[x]{.}\mathsf{bytes}|} \\
{\land}~ z{.}\mathsf{mems}{}[x]{.}\mathsf{type} = {\mathit{addrtype}}~{\mathit{limits}}~\mathsf{shared}~\mathsf{page} \\
\end{array}
} \\
{[\textsc{\scriptsize E{-}atomic.fence}]} \quad & z ; (\mathsf{atomic{.}fence}) & \hookrightarrow & z ; \epsilon \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{allocmem}}(s, {\mathit{at}}~{}[ i .. {j^?} ]~{\mathit{share}}~\mathsf{page}) & = & (s \oplus \{ \mathsf{mems}~{\mathit{meminst}} \}, {|s{.}\mathsf{mems}|}, \epsilon) &  \\
 \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{if}~ {\mathit{meminst}} = \{ \mathsf{type}~({\mathit{at}}~{}[ i .. {j^?} ]~\mathsf{unshared}~\mathsf{page}),\;\allowbreak \mathsf{bytes}~{(\mathtt{0x00})^{i \cdot 64 \, {\mathrm{Ki}}}} \}
} \\
{\mathrm{allocmem}}(s, {\mathit{at}}~{}[ i .. {j^?} ]~{\mathit{share}}~\mathsf{page}) & = & (s \oplus \{ \mathsf{mems}~{\mathit{meminst}} \}, {|s{.}\mathsf{mems}|}, {{\mathit{action}}^\ast}) &  \\
 \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ {\mathit{meminst}} = \{ \mathsf{type}~({\mathit{at}}~{}[ i .. {j^?} ]~\mathsf{shared}~\mathsf{page}),\; \mathsf{bytes}~{(\mathtt{0x00})^{i \cdot 64 \, {\mathrm{Ki}}}} \} \\
{\land}~ a = {|s{.}\mathsf{mems}|} \\
{\land}~ {{\mathit{action}}^\ast} = (\begin{array}[t]{@{}l@{}} (\mathsf{wr}~\mathsf{seqcst}~((\mathsf{reglen}~a)~0)~(\mathsf{i{\scriptstyle 32}}{.}\mathsf{const}~i)) \\
  (\mathsf{wr}~\mathsf{init}~((\mathsf{regdata}~a)~0)~(\mathsf{bytes}~{(\mathtt{0x00})^{i \cdot 64 \, {\mathrm{Ki}}}})) \end{array}) \\
\end{array}
} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lcl@{}l@{}}
{{{\mathrm{allocmem}}^\ast}}{(s, \epsilon)} & = & (s, \epsilon, \epsilon) \\
{{{\mathrm{allocmem}}^\ast}}{(s, {\mathit{memtype}}~{{\mathit{memtype}'}^\ast})} & = & (s_2, {\mathit{ma}}~{{\mathit{ma}'}^\ast}, {{\mathit{act{\kern-0.1em\scriptstyle 1}}}^\ast}~{{\mathit{act{\kern-0.1em\scriptstyle 2}}}^\ast}) & \quad
\begin{array}[t]{@{}l@{}}
\mbox{if}~ (s_1, {\mathit{ma}}, {{\mathit{act{\kern-0.1em\scriptstyle 1}}}^\ast}) = {\mathrm{allocmem}}(s, {\mathit{memtype}}) \\
{\land}~ (s_2, {{\mathit{ma}'}^\ast}, {{\mathit{act{\kern-0.1em\scriptstyle 2}}}^\ast}) = {{{\mathrm{allocmem}}^\ast}}{(s_1, {{\mathit{memtype}'}^\ast})} \\
\end{array} \\
\end{array}
$$
...
$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{allocmodule}}(s, {\mathit{module}}, {{\mathit{externaddr}}^\ast}, {{\mathit{val}}_{\mathsf{g}}^\ast}, {{\mathit{ref}}_{\mathsf{t}}^\ast}, {({{\mathit{ref}}_{\mathsf{e}}^\ast})^\ast}) & = & (s_7, {\mathit{moduleinst}}, {{\mathit{action}}^\ast}) &  \\
 \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
...
{\land}~ (s_3, {{\mathit{ma}}^\ast}, {{\mathit{action}}^\ast}) = {{{\mathrm{allocmem}}^\ast}}{(s_2, {{{\mathit{memtype}}}{{}[ {:=}\, {{\mathit{dt}}^\ast} ]}^\ast})} \\
...
$$
\begin{array}[t]{@{}lcl@{}l@{}}
{\mathrm{instantiate}}(s, {\mathit{module}}, {{\mathit{externaddr}}^\ast}) & = & {s''''} ; \{ \mathsf{module}~{\mathit{moduleinst}} \} ; \begin{array}[t]{@{}l@{}} {(\mathsf{perform}~({{\mathit{act}}^?}))^\ast} \\
  (\mathsf{perform}~{{\mathit{action}}^\ast}) \\
  {{\mathit{instr}}_{\mathsf{e}}^\ast}~{{\mathit{instr}}_{\mathsf{d}}^\ast}~{{\mathit{instr}}_{\mathsf{s}}^?} \end{array} &  \\
 \multicolumn{4}{@{}l@{}}{\quad
\quad
\begin{array}[t]{@{}l@{}}
...
{\land}~ {z'''} = {s'''} ; f \\
{\land}~ ({s''''}, {\mathit{moduleinst}}, {{\mathit{action}}^\ast}) = {\mathrm{allocmodule}}({s'''}, {\mathit{module}}, {{\mathit{externaddr}}^\ast}, {{\mathit{val}}_{\mathsf{g}}^\ast}, {{\mathit{ref}}_{\mathsf{t}}^\ast}, {({{\mathit{ref}}_{\mathsf{e}}^\ast})^\ast}) \\
...
{\mathrm{instantiate}}(s, {\mathit{module}}, {{\mathit{externaddr}}^\ast}) & = & s ; \epsilon ; \mathsf{trap} &  \\
 \multicolumn{4}{@{}l@{}}{\quad
\quad \mbox{otherwise}
} \\
\end{array}
...
& {\mathtt{memtype}} & ::= & ({\mathit{at}}, {\mathit{lim}}){:}{\mathtt{limits}} & \quad\Rightarrow\quad{} & {\mathit{at}}~{\mathit{lim}}~{\mathit{share}}~\mathsf{page} \\
...
& & | & \mathtt{0xFE}~~0{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{memory{.}atomic{.}notify}}{x}~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~1{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{memory{.}atomic{.}wait}}{\mathsf{i{\scriptstyle 32}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~2{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{memory{.}atomic{.}wait}}{\mathsf{i{\scriptstyle 64}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~3{:}{\mathtt{u32}} & \quad\Rightarrow\quad{} & \mathsf{atomic{.}fence} \\
& & | & \mathtt{0xFE}~~16{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{load}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~17{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{load}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~18{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{load}}{{\mathsf{{\scriptstyle 8}}}{\mathsf{\_}}{\mathsf{u}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~19{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{load}}{{\mathsf{{\scriptstyle 16}}}{\mathsf{\_}}{\mathsf{u}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~20{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{load}}{{\mathsf{{\scriptstyle 8}}}{\mathsf{\_}}{\mathsf{u}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~21{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{load}}{{\mathsf{{\scriptstyle 16}}}{\mathsf{\_}}{\mathsf{u}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~22{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{load}}{{\mathsf{{\scriptstyle 32}}}{\mathsf{\_}}{\mathsf{u}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~23{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{store}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~24{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{store}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~25{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{store}}{\mathsf{{\scriptstyle 8}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~26{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{store}}{\mathsf{{\scriptstyle 16}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~27{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{store}}{\mathsf{{\scriptstyle 8}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~28{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{store}}{\mathsf{{\scriptstyle 16}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~29{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{store}}{\mathsf{{\scriptstyle 32}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~30{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}~\mathsf{add}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~31{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}~\mathsf{add}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~32{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 8}}}~\mathsf{add}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~33{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 16}}}~\mathsf{add}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~34{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 8}}}~\mathsf{add}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~35{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 16}}}~\mathsf{add}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~36{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 32}}}~\mathsf{add}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~37{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}~\mathsf{sub}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~38{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}~\mathsf{sub}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~39{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 8}}}~\mathsf{sub}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~40{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 16}}}~\mathsf{sub}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~41{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 8}}}~\mathsf{sub}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~42{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 16}}}~\mathsf{sub}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~43{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 32}}}~\mathsf{sub}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~44{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}~\mathsf{and}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~45{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}~\mathsf{and}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~46{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 8}}}~\mathsf{and}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~47{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 16}}}~\mathsf{and}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~48{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 8}}}~\mathsf{and}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~49{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 16}}}~\mathsf{and}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~50{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 32}}}~\mathsf{and}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~51{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}~\mathsf{or}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~52{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}~\mathsf{or}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~53{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 8}}}~\mathsf{or}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~54{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 16}}}~\mathsf{or}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~55{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 8}}}~\mathsf{or}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~56{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 16}}}~\mathsf{or}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~57{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 32}}}~\mathsf{or}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~58{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}~\mathsf{xor}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~59{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}~\mathsf{xor}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~60{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 8}}}~\mathsf{xor}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~61{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 16}}}~\mathsf{xor}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~62{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 8}}}~\mathsf{xor}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~63{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 16}}}~\mathsf{xor}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~64{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 32}}}~\mathsf{xor}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~65{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}~\mathsf{xchg}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~66{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}~\mathsf{xchg}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~67{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 8}}}~\mathsf{xchg}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~68{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 16}}}~\mathsf{xchg}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~69{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 8}}}~\mathsf{xchg}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~70{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 16}}}~\mathsf{xchg}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~71{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}}{\mathsf{{\scriptstyle 32}}}~\mathsf{xchg}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~72{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~73{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & \mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~74{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}}{\mathsf{{\scriptstyle 8}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~75{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 32}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}}{\mathsf{{\scriptstyle 16}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~76{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}}{\mathsf{{\scriptstyle 8}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~77{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}}{\mathsf{{\scriptstyle 16}}}~x~{\mathit{ao}} \\
& & | & \mathtt{0xFE}~~78{:}{\mathtt{u32}}~~(x, {\mathit{ao}}){:}{\mathtt{memarg}} & \quad\Rightarrow\quad{} & {\mathsf{i{\scriptstyle 64}}{.}\mathsf{atomic}{.}\mathsf{rmw}{.}\mathsf{cmpxchg}}{\mathsf{{\scriptstyle 32}}}~x~{\mathit{ao}} \\
\end{array}
$$
...
& {{\mathtt{memtype}}}_{I} & ::= & {\mathit{at}}{:}{\mathtt{addrtype}}~~{\mathit{lim}}{:}{\mathtt{limits}} & \quad\Rightarrow\quad{} & {\mathit{at}}~{\mathit{lim}}~{\mathit{share}}~\mathsf{page} \\
