...
def subst_typevar : ∀  (v_typevar : typevar) (var_0 : (List typevar)) (var_1 : (List typeuse)) , typeuse
  | tv, [], [] =>
    (typeuse_typevar tv)
  | tv, (tv_1 :: tv'_lst), (tu_1 :: tu'_lst) =>
    if (tv == tv_1) then
      tu_1
    else
      (subst_typevar tv tv'_lst tu'_lst)
...
def subst_typeuse : ∀  (v_typeuse : typeuse) (var_0 : (List typevar)) (var_1 : (List typeuse)) , typeuse
  | (.REC v_n), tv_lst, tu_lst =>
    (subst_typevar (.REC v_n) tv_lst tu_lst)
  | (._IDX v_typeidx), tv_lst, tu_lst =>
    (subst_typevar (._IDX v_typeidx) tv_lst tu_lst)
  | (._DEF v_rectype v_n), tv_lst, tu_lst =>
    (typeuse_deftype (subst_deftype (._DEF v_rectype v_n) tv_lst tu_lst))
...
def subst_storagetype : ∀  (v_storagetype : storagetype) (var_0 : (List typevar)) (var_1 : (List typeuse)) , storagetype
  | .BOT, tv_lst, tu_lst =>
    (storagetype_valtype (subst_valtype .BOT tv_lst tu_lst))
  | (.REF null_opt v_heaptype), tv_lst, tu_lst =>
    (storagetype_valtype (subst_valtype (.REF null_opt v_heaptype) tv_lst tu_lst))
  | .V128, tv_lst, tu_lst =>
    (storagetype_valtype (subst_valtype .V128 tv_lst tu_lst))
  | .F64, tv_lst, tu_lst =>
    (storagetype_valtype (subst_valtype .F64 tv_lst tu_lst))
  | .F32, tv_lst, tu_lst =>
    (storagetype_valtype (subst_valtype .F32 tv_lst tu_lst))
  | .I64, tv_lst, tu_lst =>
    (storagetype_valtype (subst_valtype .I64 tv_lst tu_lst))
  | .I32, tv_lst, tu_lst =>
    (storagetype_valtype (subst_valtype .I32 tv_lst tu_lst))
  | .I8, tv_lst, tu_lst =>
    (storagetype_packtype (subst_packtype .I8 tv_lst tu_lst))
  | .I16, tv_lst, tu_lst =>
    (storagetype_packtype (subst_packtype .I16 tv_lst tu_lst))
...
def subst_deftype : ∀  (v_deftype : deftype) (var_0 : (List typevar)) (var_1 : (List typeuse)) , deftype
  | (._DEF qt i), tv_lst, tu_lst =>
    (._DEF (subst_rectype qt tv_lst tu_lst) i)
...
def subst_tagtype : ∀  (v_tagtype : tagtype) (var_0 : (List typevar)) (var_1 : (List typeuse)) , tagtype
  | tu', tv_lst, tu_lst =>
    (subst_typeuse tu' tv_lst tu_lst)
...
def subst_all_deftypes : ∀  (var_0 : (List deftype)) (var_1 : (List typeuse)) , (List deftype)
  | [], tu_lst =>
    []
  | (dt_1 :: dt_lst), tu_lst =>
    ([(subst_all_deftype dt_1 tu_lst)] ++ (subst_all_deftypes dt_lst tu_lst))
...
def free_heaptype : ∀  (v_heaptype : heaptype) , free
  | .ANY =>
    (free_absheaptype .ANY)
  | .EQ =>
    (free_absheaptype .EQ)
  | .I31 =>
    (free_absheaptype .I31)
  | .STRUCT =>
    (free_absheaptype .STRUCT)
  | .ARRAY =>
    (free_absheaptype .ARRAY)
  | .NONE =>
    (free_absheaptype .NONE)
  | .FUNC =>
    (free_absheaptype .FUNC)
  | .NOFUNC =>
    (free_absheaptype .NOFUNC)
  | .EXN =>
    (free_absheaptype .EXN)
  | .NOEXN =>
    (free_absheaptype .NOEXN)
  | .EXTERN =>
    (free_absheaptype .EXTERN)
  | .NOEXTERN =>
    (free_absheaptype .NOEXTERN)
  | .BOT =>
    (free_absheaptype .BOT)
  | (.REC n_0) =>
    (free_typeuse (.REC n_0))
  | (._DEF v_rectype v_n) =>
    (free_typeuse (._DEF v_rectype v_n))
  | (._IDX v_typeidx) =>
    (free_typeuse (._IDX v_typeidx))
...
def free_typeuse : ∀  (v_typeuse : typeuse) , free
  | (.REC v_n) =>
    (free_typevar (.REC v_n))
  | (._IDX v_typeidx) =>
    (free_typevar (._IDX v_typeidx))
  | (._DEF v_rectype v_n) =>
    (free_deftype (._DEF v_rectype v_n))
...
def free_resulttype : ∀  (v_resulttype : resulttype) , free
  | (.mk_list valtype_lst) =>
    (free_list (List.map (fun (v_valtype : valtype) => (free_valtype v_valtype)) valtype_lst))
...
def free_storagetype : ∀  (v_storagetype : storagetype) , free
  | .BOT =>
    (free_valtype .BOT)
  | (.REF null_opt v_heaptype) =>
    (free_valtype (.REF null_opt v_heaptype))
  | .V128 =>
    (free_valtype .V128)
  | .F64 =>
    (free_valtype .F64)
...
def free_fieldtype : ∀  (v_fieldtype : fieldtype) , free
  | (.mk_fieldtype mut_opt v_storagetype) =>
    (free_storagetype v_storagetype)
...
def free_comptype : ∀  (v_comptype : comptype) , free
  | (.STRUCT (.mk_list fieldtype_lst)) =>
    (free_list (List.map (fun (v_fieldtype : fieldtype) => (free_fieldtype v_fieldtype)) fieldtype_lst))
  | (.ARRAY v_fieldtype) =>
    (free_fieldtype v_fieldtype)
  | (.FUNC resulttype_1 resulttype_2) =>
...
def free_subtype : ∀  (v_subtype : subtype) , free
  | (.SUB final_opt typeuse_lst v_comptype) =>
    ((free_list (List.map (fun (v_typeuse : typeuse) => (free_typeuse v_typeuse)) typeuse_lst)) ++ (free_comptype v_comptype))
...
def free_rectype : ∀  (v_rectype : rectype) , free
  | (.REC (.mk_list subtype_lst)) =>
    (free_list (List.map (fun (v_subtype : subtype) => (free_subtype v_subtype)) subtype_lst))
...
def free_globaltype : ∀  (v_globaltype : globaltype) , free
  | (.mk_globaltype mut_opt v_valtype) =>
    (free_valtype v_valtype)
...
def free_tabletype : ∀  (v_tabletype : tabletype) , free
  | (.mk_tabletype v_addrtype v_limits v_reftype) =>
    ((free_addrtype (numtype_addrtype v_addrtype)) ++ (free_reftype v_reftype))
...
def free_elemtype : ∀  (v_elemtype : elemtype) , free
  | v_reftype =>
    (free_reftype v_reftype)


/- Auxiliary Definition at: ../../../../specification/wasm-3.0/1.2-syntax.types.spectec:503.1-503.54 -/
def free_externtype : ∀  (v_externtype : externtype) , (Option free)
  | (.TAG v_tagtype) =>
    (some (Option.get! (free_tagtype v_tagtype)))
  | (.GLOBAL v_globaltype) =>
    (some (free_globaltype v_globaltype))
  | (.MEM v_memtype) =>
    (some (free_memtype v_memtype))
  | (.TABLE v_tabletype) =>
    (some (free_tabletype v_tabletype))
  | (.FUNC v_typeuse) =>
    (some (free_typeuse v_typeuse))
  | x0 =>
    none
...
def free_moduletype : ∀  (v_moduletype : moduletype) , free
  | (.mk_moduletype externtype_1_lst externtype_2_lst) =>
    ((free_list (List.map (fun (externtype_1 : externtype) => (Option.get! (free_externtype externtype_1))) externtype_1_lst)) ++ (free_list (List.map (fun (externtype_2 : externtype) => (Option.get! (free_externtype externtype_2))) externtype_2_lst)))
...
def free_blocktype : ∀  (v_blocktype : blocktype) , free
  | (._RESULT valtype_opt) =>
    (free_opt (Option.map (fun (v_valtype : valtype) => (free_valtype v_valtype)) valtype_opt))
  | (._IDX v_funcidx) =>
    (free_funcidx v_funcidx)
...
def free_expr : ∀  (v_expr : expr) , free
  | instr_lst =>
    (free_list (List.map (fun (v_instr : instr) => (free_instr v_instr)) instr_lst))
...
def free_table : ∀  (v_table : table) , free
  | (.TABLE v_tabletype v_expr) =>
    ((free_tabletype v_tabletype) ++ (free_expr v_expr))
...
def free_func : ∀  (v_func : func) , free
  | (.FUNC v_typeidx local_lst v_expr) =>
    (((free_typeidx v_typeidx) ++ (free_list (List.map (fun (v_local : «local») => (free_local v_local)) local_lst))) ++ ((free_block v_expr) <| LOCALS := [] |>))
...
def free_data : ∀  (v_data : data) , free
  | (.DATA byte_lst v_datamode) =>
    (free_datamode v_datamode)
...
def free_elem : ∀  (v_elem : elem) , free
  | (.ELEM v_reftype expr_lst v_elemmode) =>
    (((free_reftype v_reftype) ++ (free_list (List.map (fun (v_expr : expr) => (free_expr v_expr)) expr_lst))) ++ (free_elemmode v_elemmode))
...
def free_import : ∀  (v_import : «import») , free
  | (.IMPORT name_1 name_2 v_externtype) =>
    (Option.get! (free_externtype v_externtype))
...
def free_module : ∀  (v_module : module) , free
  | (.MODULE type_lst import_lst tag_lst global_lst mem_lst table_lst func_lst data_lst elem_lst start_opt export_lst) =>
    (((((((((((free_list (List.map (fun (v_type : type) => (free_type v_type)) type_lst)) ++ (free_list (List.map (fun (v_tag : tag) => (free_tag v_tag)) tag_lst))) ++ (free_list (List.map (fun (v_global : global) => (free_global v_global)) global_lst))) ++ (free_list (List.map (fun (v_mem : mem) => (free_mem v_mem)) mem_lst))) ++ (free_list (List.map (fun (v_table : table) => (free_table v_table)) table_lst))) ++ (free_list (List.map (fun (v_func : func) => (free_func v_func)) func_lst))) ++ (free_list (List.map (fun (v_data : data) => (free_data v_data)) data_lst))) ++ (free_list (List.map (fun (v_elem : elem) => (free_elem v_elem)) elem_lst))) ++ (free_opt (Option.map (fun (v_start : start) => (free_start v_start)) start_opt))) ++ (free_list (List.map (fun (v_import : «import») => (free_import v_import)) import_lst))) ++ (free_list (List.map (fun (v_export : «export») => (free_export v_export)) export_lst)))
...
def dataidx_funcs : ∀  (var_0 : (List func)) , (List dataidx)
  | func_lst =>
    ((free_list (List.map (fun (v_func : func) => (free_func v_func)) func_lst)).DATAS)
...
def with_locals : ∀  (v_context : context) (var_0 : (List localidx)) (var_1 : (List localtype)) , context
  | C, [], [] =>
    C
  | C, (x_1 :: x_lst), (lct_1 :: lct_lst) =>
    (with_locals (C <| LOCALS := (List.modify (C.LOCALS) (proj_uN_0 x_1) (fun (_ : localtype) => lct_1)) |>) x_lst lct_lst)
...
def unrollht : ∀  (v_context : context) (v_heaptype : heaptype) , subtype
  | C, (._DEF v_rectype v_n) =>
    (unrolldt (._DEF v_rectype v_n))
  | C, (._IDX v_typeidx) =>
    (unrolldt ((C.TYPES)[(proj_uN_0 v_typeidx)]!))
  | C, (.REC i) =>
    ((C.RECS)[i]!)
...
inductive Instr_ok : context -> instr -> instrtype -> Prop where
  ...
  | load_pack : forall (C : context) (v_Inn : Inn) (v_M : M) (v_sx : sx) (x : idx) (v_memarg : memarg) («at» : addrtype) (lim : limits),
    (wf_context C) ->
    (wf_instr (.LOAD (numtype_addrtype v_Inn) (some (.mk_loadop__0 v_Inn (.mk_loadop_Inn (.mk_sz v_M) v_sx))) x v_memarg)) ->
...
def fun_relaxed2 : ∀  (v_relaxed2 : relaxed2) (X : Type) (X_0 : X) (X_1 : X) , X
  | i, X, X_1, X_2 =>
    if (ND ) then
      ([X_1, X_2][(proj_relaxed2_0 i)]!)
    else
      ([X_1, X_2][0]!)


/- Auxiliary Definition at: ../../../../specification/wasm-3.0/3.0-numerics.relaxed.spectec:9.1-9.89 -/
def fun_relaxed4 : ∀  (v_relaxed4 : relaxed4) (X : Type) (X_0 : X) (X_1 : X) (X_2 : X) (X_3 : X) , X
  | i, X, X_1, X_2, X_3, X_4 =>
    if (ND ) then
      ([X_1, X_2, X_3, X_4][(proj_relaxed4_0 i)]!)
    else
      ([X_1, X_2, X_3, X_4][0]!)
...
def iabs_ : ∀  (v_N : N) (v_iN : iN) , iN
  | v_N, i_1 =>
    if ((signed_ v_N (proj_uN_0 i_1)) >= (0 : Nat)) then
      i_1
    else
      (ineg_ v_N i_1)
...
inductive Step_pure : (List instr) -> (List instr) -> Prop where
  ...
  | br_table_lt : forall (i : num_) (l_lst : (List labelidx)) (l' : labelidx),
    ...
    (wf_instr (.BR_TABLE l_lst l')) ->
    (wf_instr (.BR (l_lst[(proj_uN_0 (Option.get! (proj_num__0 i)))]!))) ->
  ...
  | ref_i31 : forall (i : num_),
    ...
    (wf_instr (.CONST .I32 i)) ->
    (wf_instr .REF_I31) ->
    (wf_instr (.REF_I31_NUM (wrap__ 32 31 (Option.get! (proj_num__0 i))))) ->
  ...
  | vvtestop : forall (c_1 : vec_) (c : num_),
    ...
    (wf_uN 128 (.mk_uN 0)) ->
    ((proj_num__0 c) != none) ->
    ((Option.get! (proj_num__0 c)) == (ine_ (vsize .V128) c_1 (.mk_uN 0))) ->
  ...
  | vtestop : forall (c_1 : vec_) (sh : shape) (vtestop : vtestop_) (i : num_),
    ...
    (wf_instr (.CONST .I32 i)) ->
    ((proj_num__0 i) != none) ->
    ((Option.get! (proj_num__0 i)) == (fun_vtestop_ sh vtestop c_1)) ->
  ...
  | vshiftop : forall (c_1 : vec_) (i : num_) (sh : ishape) (vshiftop : vshiftop_) (c : vec_),
    ...
    (wf_instr (.VCONST .V128 c)) ->
    ((proj_num__0 i) != none) ->
    (c == (fun_vshiftop_ sh vshiftop c_1 (Option.get! (proj_num__0 i)))) ->
  ...
  | vbitmask : forall (c_1 : vec_) (sh : ishape) (c : num_),
    ...
    (wf_instr (.CONST .I32 c)) ->
    ((proj_num__0 c) != none) ->
    ((Option.get! (proj_num__0 c)) == (vbitmaskop_ sh c_1)) ->
...
inductive Step_read_before_table_copy_gt : config -> Prop where
  | table_copy_le_0 : forall (z : state) (at_1 : addrtype) (i_1 : num_) (at_2 : addrtype) (i_2 : num_) (at' : addrtype) (v_n : n) (x : idx) (y : idx),
    ...
    (wf_instr (.TABLE_SET x)) ->
    ((proj_num__0 i_1) != none) ->
    (wf_instr (.CONST (numtype_addrtype at_1) (.mk_num__0 at_1 (.mk_uN ((proj_uN_0 (Option.get! (proj_num__0 i_1))) + 1))))) ->
    ((proj_num__0 i_2) != none) ->
    (wf_instr (.CONST (numtype_addrtype at_2) (.mk_num__0 at_2 (.mk_uN ((proj_uN_0 (Option.get! (proj_num__0 i_2))) + 1))))) ->
...
inductive Step_read_before_memory_copy_gt : config -> Prop where
  | memory_copy_le_0 : forall (z : state) (at_1 : addrtype) (i_1 : num_) (at_2 : addrtype) (i_2 : num_) (at' : addrtype) (v_n : n) (x_1 : idx) (x_2 : idx),
    ...
    (wf_instr (.CONST (numtype_addrtype at_1) i_1)) ->
    (wf_instr (.CONST (numtype_addrtype at_2) i_2)) ->
    (wf_instr (.LOAD .I32 (some (.mk_loadop__0 .I32 (.mk_loadop_Inn (.mk_sz 8) .U))) x_2 (memarg0 ))) ->
...
inductive Step_read_before_array_copy_gt : config -> Prop where
  | array_copy_le_0 : forall (z : state) (a_1 : addr) (i_1 : num_) (a_2 : addr) (i_2 : num_) (v_n : n) (x_1 : idx) (x_2 : idx) (sx_opt : (Option sx)) (mut_opt : (Option «mut»)) (zt_2 : storagetype),
    ...
    ((proj_num__0 i_1) != none) ->
    (wf_instr (.CONST .I32 (.mk_num__0 .I32 (.mk_uN ((proj_uN_0 (Option.get! (proj_num__0 i_1))) + 1))))) ->
    ((proj_num__0 i_2) != none) ->
    (wf_instr (.CONST .I32 (.mk_num__0 .I32 (.mk_uN ((proj_uN_0 (Option.get! (proj_num__0 i_2))) + 1))))) ->
...
inductive Step_read_before_array_init_data_zero : config -> Prop where
  | array_init_data_oob2_0 : forall (z : state) (a : addr) (i : num_) (j : num_) (v_n : n) (x : idx) (y : idx) (mut_opt : (Option «mut»)) (zt : storagetype),
    ...
    ((proj_num__0 j) != none) ->
    ((zsize zt) != none) ->
    (((proj_uN_0 (Option.get! (proj_num__0 j))) + ((((v_n * (Option.get! (zsize zt))) : Nat) / (8 : Nat)) : Nat)) > (List.length ((fun_data z y).BYTES))) ->
...
inductive Step_read : config -> (List instr) -> Prop where
  ...
  | table_fill_succ : forall (z : state) («at» : addrtype) (i : num_) (v_val : val) (v_n : n) (x : idx),
    ...
    (wf_instr (.TABLE_SET x)) ->
    (wf_instr (.CONST (numtype_addrtype «at») (.mk_num__0 «at» (.mk_uN ((proj_uN_0 (Option.get! (proj_num__0 i))) + 1))))) ->
    (wf_instr (.CONST (numtype_addrtype «at») (.mk_num__0 «at» (.mk_uN (((v_n : Nat) - (1 : Nat)) : Nat))))) ->
    (wf_instr (.TABLE_FILL x)) ->
    (¬(Step_read_before_table_fill_succ (.mk_config z [(.CONST (numtype_addrtype «at») i), (instr_val v_val), (.CONST (numtype_addrtype «at») (.mk_num__0 «at» (.mk_uN v_n))), (.TABLE_FILL x)]))) ->
  ...
  | table_copy_gt : forall (z : state) (at_1 : addrtype) (i_1 : num_) (at_2 : addrtype) (i_2 : num_) (at' : addrtype) (v_n : n) (x : idx) (y : idx),
    ...
    ((proj_num__0 i_2) != none) ->
    (wf_config (.mk_config z [(.CONST (numtype_addrtype at_1) i_1), (.CONST (numtype_addrtype at_2) i_2), (.CONST (numtype_addrtype at') (.mk_num__0 at' (.mk_uN v_n))), (.TABLE_COPY x y)])) ->
    (wf_instr (.CONST (numtype_addrtype at_1) (.mk_num__0 at_1 (.mk_uN (((((proj_uN_0 (Option.get! (proj_num__0 i_1))) + v_n) : Nat) - (1 : Nat)) : Nat))))) ->
    (wf_instr (.CONST (numtype_addrtype at_2) (.mk_num__0 at_2 (.mk_uN (((((proj_uN_0 (Option.get! (proj_num__0 i_2))) + v_n) : Nat) - (1 : Nat)) : Nat))))) ->
    (wf_instr (.TABLE_GET y)) ->
    (wf_instr (.TABLE_SET x)) ->
    (wf_instr (.CONST (numtype_addrtype at_1) i_1)) ->
    (wf_instr (.CONST (numtype_addrtype at_2) i_2)) ->
  ...
  | table_init_succ : forall (z : state) («at» : addrtype) (i : num_) (j : num_) (v_n : n) (x : idx) (y : idx),
    ...
    (wf_instr (.TABLE_SET x)) ->
    (wf_instr (.CONST (numtype_addrtype «at») (.mk_num__0 «at» (.mk_uN ((proj_uN_0 (Option.get! (proj_num__0 i))) + 1))))) ->
    (wf_instr (.CONST .I32 (.mk_num__0 .I32 (.mk_uN ((proj_uN_0 (Option.get! (proj_num__0 j))) + 1))))) ->
    (wf_instr (.CONST .I32 (.mk_num__0 .I32 (.mk_uN (((v_n : Nat) - (1 : Nat)) : Nat))))) ->
    (wf_instr (.TABLE_INIT x y)) ->
    (¬(Step_read_before_table_init_succ (.mk_config z [(.CONST (numtype_addrtype «at») i), (.CONST .I32 j), (.CONST .I32 (.mk_num__0 .I32 (.mk_uN v_n))), (.TABLE_INIT x y)]))) ->
  ...
  | load_pack_oob : forall (z : state) («at» : addrtype) (i : num_) (v_Inn : Inn) (v_n : n) (v_sx : sx) (x : idx) (ao : memarg),
    (wf_config (.mk_config z [(.CONST (numtype_addrtype «at») i), (.LOAD (numtype_addrtype v_Inn) (some (.mk_loadop__0 v_Inn (.mk_loadop_Inn (.mk_sz v_n) v_sx))) x ao)])) ->
    (wf_instr .TRAP) ->
    ((proj_num__0 i) != none) ->
  ...
  | memory_init_succ : forall (z : state) («at» : addrtype) (i : num_) (j : num_) (v_n : n) (x : idx) (y : idx),
    ...
    (wf_config (.mk_config z [(.CONST (numtype_addrtype «at») i), (.CONST .I32 j), (.CONST .I32 (.mk_num__0 .I32 (.mk_uN v_n))), (.MEMORY_INIT x y)])) ->
    (wf_instr (.CONST (numtype_addrtype «at») i)) ->
    (wf_instr (.CONST .I32 (.mk_num__0 .I32 (.mk_uN (proj_byte_0 (((fun_data z y).BYTES)[(proj_uN_0 (Option.get! (proj_num__0 j)))]!)))))) ->
    (wf_instr (.STORE .I32 (some (.mk_storeop__0 .I32 (.mk_storeop_Inn (.mk_sz 8)))) x (memarg0 ))) ->
    (wf_instr (.CONST (numtype_addrtype «at») (.mk_num__0 «at» (.mk_uN ((proj_uN_0 (Option.get! (proj_num__0 i))) + 1))))) ->
    (wf_instr (.CONST .I32 (.mk_num__0 .I32 (.mk_uN ((proj_uN_0 (Option.get! (proj_num__0 j))) + 1))))) ->
    (wf_instr (.CONST .I32 (.mk_num__0 .I32 (.mk_uN (((v_n : Nat) - (1 : Nat)) : Nat))))) ->
  ...
  | array_new_data_oob : forall (z : state) (i : num_) (v_n : n) (x : idx) (y : idx) (mut_opt : (Option «mut»)) (zt : storagetype),
    ...
    ((proj_num__0 i) != none) ->
    ((zsize zt) != none) ->
    (((proj_uN_0 (Option.get! (proj_num__0 i))) + ((((v_n * (Option.get! (zsize zt))) : Nat) / (8 : Nat)) : Nat)) > (List.length ((fun_data z y).BYTES))) ->
  ...
  | array_new_data_num : forall (z : state) (i : num_) (v_n : n) (x : idx) (y : idx) (zt : storagetype) (c_lst : (List lit_)) (mut_opt : (Option «mut»)),
    ...
    ((zsize zt) != none) ->
    ((proj_num__0 i) != none) ->
    ((concatn_ byte (List.map (fun (c : lit_) => (zbytes_ zt c)) c_lst) ((((Option.get! (zsize zt)) : Nat) / (8 : Nat)) : Nat)) == (List.extract ((fun_data z y).BYTES) (proj_uN_0 (Option.get! (proj_num__0 i))) ((((v_n * (Option.get! (zsize zt))) : Nat) / (8 : Nat)) : Nat))) ->
  ...
  | array_fill_succ : forall (z : state) (a : addr) (i : num_) (v_val : val) (v_n : n) (x : idx),
    ...
    (wf_instr (.CONST .I32 i)) ->
    (wf_instr (.ARRAY_SET x)) ->
    (wf_instr (.CONST .I32 (.mk_num__0 .I32 (.mk_uN ((proj_uN_0 (Option.get! (proj_num__0 i))) + 1))))) ->
    (wf_instr (.CONST .I32 (.mk_num__0 .I32 (.mk_uN (((v_n : Nat) - (1 : Nat)) : Nat))))) ->
    (wf_instr (.ARRAY_FILL x)) ->
    (¬(Step_read_before_array_fill_succ (.mk_config z [(.REF_ARRAY_ADDR a), (.CONST .I32 i), (instr_val v_val), (.CONST .I32 (.mk_num__0 .I32 (.mk_uN v_n))), (.ARRAY_FILL x)]))) ->
  ...
  | array_copy_gt : forall (z : state) (a_1 : addr) (i_1 : num_) (a_2 : addr) (i_2 : num_) (v_n : n) (x_1 : idx) (x_2 : idx) (sx_opt : (Option sx)) (mut_opt : (Option «mut»)) (zt_2 : storagetype),
    ...
    (wf_config (.mk_config z [(.REF_ARRAY_ADDR a_1), (.CONST .I32 i_1), (.REF_ARRAY_ADDR a_2), (.CONST .I32 i_2), (.CONST .I32 (.mk_num__0 .I32 (.mk_uN v_n))), (.ARRAY_COPY x_1 x_2)])) ->
    (wf_instr (.REF_ARRAY_ADDR a_1)) ->
    (wf_instr (.CONST .I32 (.mk_num__0 .I32 (.mk_uN (((((proj_uN_0 (Option.get! (proj_num__0 i_1))) + v_n) : Nat) - (1 : Nat)) : Nat))))) ->
    (wf_instr (.REF_ARRAY_ADDR a_2)) ->
    (wf_instr (.CONST .I32 (.mk_num__0 .I32 (.mk_uN (((((proj_uN_0 (Option.get! (proj_num__0 i_2))) + v_n) : Nat) - (1 : Nat)) : Nat))))) ->
    (wf_instr (.ARRAY_GET sx_opt x_2)) ->
    (wf_instr (.ARRAY_SET x_1)) ->
    (wf_instr (.CONST .I32 i_1)) ->
    (wf_instr (.CONST .I32 i_2)) ->
  ...
  | array_init_data_num : forall (z : state) (a : addr) (i : num_) (j : num_) (v_n : n) (x : idx) (y : idx) (zt : storagetype) (c : lit_) (mut_opt : (Option «mut»)),
    ...
    (wf_instr (.ARRAY_SET x)) ->
    (wf_instr (.CONST .I32 (.mk_num__0 .I32 (.mk_uN ((proj_uN_0 (Option.get! (proj_num__0 i))) + 1))))) ->
    (wf_instr (.CONST .I32 (.mk_num__0 .I32 (.mk_uN ((proj_uN_0 (Option.get! (proj_num__0 j))) + ((((Option.get! (zsize zt)) : Nat) / (8 : Nat)) : Nat)))))) ->
    (wf_instr (.CONST .I32 (.mk_num__0 .I32 (.mk_uN (((v_n : Nat) - (1 : Nat)) : Nat))))) ->
    (wf_instr (.ARRAY_INIT_DATA x y)) ->
    (wf_comptype (.ARRAY (.mk_fieldtype mut_opt zt))) ->
    (¬(Step_read_before_array_init_data_num (.mk_config z [(.REF_ARRAY_ADDR a), (.CONST .I32 i), (.CONST .I32 j), (.CONST .I32 (.mk_num__0 .I32 (.mk_uN v_n))), (.ARRAY_INIT_DATA x y)]))) ->
    (Expand (fun_type z x) (.ARRAY (.mk_fieldtype mut_opt zt))) ->
    ((zbytes_ zt c) == (List.extract ((fun_data z y).BYTES) (proj_uN_0 (Option.get! (proj_num__0 j))) ((((Option.get! (zsize zt)) : Nat) / (8 : Nat)) : Nat))) ->
    Step_read (.mk_config z [(.REF_ARRAY_ADDR a), (.CONST .I32 i), (.CONST .I32 j), (.CONST .I32 (.mk_num__0 .I32 (.mk_uN v_n))), (.ARRAY_INIT_DATA x y)]) [(.REF_ARRAY_ADDR a), (.CONST .I32 i), (const (Option.get! (cunpack zt)) (cunpacknum_ zt c)), (.ARRAY_SET x), (.REF_ARRAY_ADDR a), (.CONST .I32 (.mk_num__0 .I32 (.mk_uN ((proj_uN_0 (Option.get! (proj_num__0 i))) + 1)))), (.CONST .I32 (.mk_num__0 .I32 (.mk_uN ((proj_uN_0 (Option.get! (proj_num__0 j))) + ((((Option.get! (zsize zt)) : Nat) / (8 : Nat)) : Nat))))), (.CONST .I32 (.mk_num__0 .I32 (.mk_uN (((v_n : Nat) - (1 : Nat)) : Nat)))), (.ARRAY_INIT_DATA x y)]
...
inductive Step : config -> config -> Prop where
  ...
  | table_set_val : forall (z : state) («at» : addrtype) (i : num_) (v_ref : ref) (x : idx),
    ((proj_num__0 i) != none) ->
    (wf_config (.mk_config z [(.CONST (numtype_addrtype «at») i), (instr_ref v_ref), (.TABLE_SET x)])) ->
    (wf_config (.mk_config (with_table z x (proj_uN_0 (Option.get! (proj_num__0 i))) v_ref) [])) ->
    ((proj_uN_0 (Option.get! (proj_num__0 i))) < (List.length ((fun_table z x).REFS))) ->
  ...
  | store_num_val : forall (z : state) («at» : addrtype) (i : num_) (nt : numtype) (c : num_) (x : idx) (ao : memarg) (b_lst : (List byte)),
    ((proj_num__0 i) != none) ->
    (wf_config (.mk_config z [(.CONST (numtype_addrtype «at») i), (.CONST nt c), (.STORE nt none x ao)])) ->
    (wf_config (.mk_config (with_mem z x ((proj_uN_0 (Option.get! (proj_num__0 i))) + (proj_uN_0 (ao.OFFSET))) ((((size nt) : Nat) / (8 : Nat)) : Nat) b_lst) [])) ->
    (b_lst == (nbytes_ nt c)) ->
  ...
  | store_pack_val : forall (z : state) («at» : addrtype) (i : num_) (v_Inn : Inn) (c : num_) (v_n : n) (x : idx) (ao : memarg) (b_lst : (List byte)),
    ((proj_num__0 i) != none) ->
    (wf_config (.mk_config z [(.CONST (numtype_addrtype «at») i), (.CONST (numtype_addrtype v_Inn) c), (.STORE (numtype_addrtype v_Inn) (some (.mk_storeop__0 v_Inn (.mk_storeop_Inn (.mk_sz v_n)))) x ao)])) ->
    (wf_config (.mk_config (with_mem z x ((proj_uN_0 (Option.get! (proj_num__0 i))) + (proj_uN_0 (ao.OFFSET))) (((v_n : Nat) / (8 : Nat)) : Nat) b_lst) [])) ->
    ((proj_num__0 c) != none) ->
  ...
  | vstore_val : forall (z : state) («at» : addrtype) (i : num_) (c : vec_) (x : idx) (ao : memarg) (b_lst : (List byte)),
    ((proj_num__0 i) != none) ->
    (wf_config (.mk_config z [(.CONST (numtype_addrtype «at») i), (.VCONST .V128 c), (.VSTORE .V128 x ao)])) ->
    (wf_config (.mk_config (with_mem z x ((proj_uN_0 (Option.get! (proj_num__0 i))) + (proj_uN_0 (ao.OFFSET))) ((((vsize .V128) : Nat) / (8 : Nat)) : Nat) b_lst) [])) ->
  ...
  | vstore_lane_val : forall (z : state) («at» : addrtype) (i : num_) (c : vec_) (v_N : N) (x : idx) (ao : memarg) (j : laneidx) (b_lst : (List byte)) (v_Jnn : Jnn) (v_M : M),
    ...
    (wf_uN v_N (.mk_uN (proj_uN_0 (Option.get! (proj_lane__2 ((lanes_ (.X (lanetype_Jnn v_Jnn) (.mk_dim v_M)) c)[(proj_uN_0 j)]!)))))) ->
    (v_N == (jsize v_Jnn)) ->
    ((v_M : Nat) == ((128 : Nat) / (v_N : Nat))) ->
  ...
  | array_set_array : forall (z : state) (a : addr) (i : num_) (v_val : val) (x : idx) (zt : storagetype) (mut_opt : (Option «mut»)),
    ((proj_num__0 i) != none) ->
    (wf_config (.mk_config z [(.REF_ARRAY_ADDR a), (.CONST .I32 i), (instr_val v_val), (.ARRAY_SET x)])) ->
    (wf_config (.mk_config (with_array z a (proj_uN_0 (Option.get! (proj_num__0 i))) (packfield_ zt v_val)) [])) ->
    (wf_comptype (.ARRAY (.mk_fieldtype mut_opt zt))) ->
    (Expand (fun_type z x) (.ARRAY (.mk_fieldtype mut_opt zt))) ->
