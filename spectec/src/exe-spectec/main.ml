...
let all_passes = [ MonoTypeParams; TypeFamilyRemoval; Undep; Totalize; Else; Sideconditions; ]
...
let pass_flag = function
  ...
  | MonoTypeParams -> "monomorphize-type-params"
...
let pass_desc = function
  ...
  | MonoTypeParams -> "Monomorphize type parameters"
...
let run_pass : pass -> Il.Ast.script -> Il.Ast.script = function
  ...
  | MonoTypeParams -> Middlend.Monotypeparams.transform
